...
use Typo3RectorPrefix20210401\Symplify\SetConfigResolver\Bootstrap\InvalidSetReporter;
...
$autoloadIncluder = new \Typo3RectorPrefix20210401\AutoloadIncluder();
$autoloadIncluder->includeDependencyOrRepositoryVendorAutoloadIfExists();
$autoloadIncluder->loadIfExistsAndNotLoadedYet(__DIR__ . '/../vendor/scoper-autoload.php');
$autoloadIncluder->loadIfExistsAndNotLoadedYet(\getcwd() . '/vendor/autoload.php');
$autoloadIncluder->autoloadProjectAutoloaderFile();
$autoloadIncluder->autoloadFromCommandLine();
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \Typo3RectorPrefix20210401\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
try {
    ...
    $invalidSetReporter = new \Typo3RectorPrefix20210401\Symplify\SetConfigResolver\Bootstrap\InvalidSetReporter();
...
\class_alias('Typo3RectorPrefix20210401\\AutoloadIncluder', 'AutoloadIncluder', \false);
