...
final class RouterListToControllerAnnotationsRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const ROUTE_LIST_CLASS = 'Typo3RectorPrefix20210318\\Nette\\Application\\Routers\\RouteList';
    /**
...
CODE_SAMPLE
    ...
    private function resolveAssignRouteNodes(\PhpParser\Node\Stmt\ClassMethod $classMethod) : array
    {
        ...
        return $this->betterNodeFinder->find((array) $classMethod->stmts, function (\PhpParser\Node $node) : bool {
            ...
            if ($this->isObjectTypes($node->expr, ['Typo3RectorPrefix20210318\\Nette\\Application\\IRouter', 'Typo3RectorPrefix20210318\\Nette\\Routing\\Router'])) {
                return \true;
            }
    ...
    private function isRouteStaticCallMatch(\PhpParser\Node\Expr\StaticCall $staticCall) : bool
    {
        ...
        return \is_a($staticCallReturnType, 'Typo3RectorPrefix20210318\\Nette\\Application\\IRouter', \true);
    }
    ...
    private function resolvePathFromClassAndMethodNodes(\PhpParser\Node\Stmt\Class_ $class, \PhpParser\Node\Stmt\ClassMethod $classMethod) : string
    {
        ...
        $presenterPart = \Typo3RectorPrefix20210318\Nette\Utils\Strings::after($presenterName, '\\', -1);
        $presenterPart = \Typo3RectorPrefix20210318\Nette\Utils\Strings::substring($presenterPart, 0, -\Typo3RectorPrefix20210318\Nette\Utils\Strings::length('Presenter'));
        $presenterPart = \Rector\Core\Util\StaticRectorStrings::camelCaseToDashes($presenterPart);
        $match = (array) \Typo3RectorPrefix20210318\Nette\Utils\Strings::match($this->getName($classMethod), self::ACTION_RENDER_NAME_MATCHING_REGEX);
