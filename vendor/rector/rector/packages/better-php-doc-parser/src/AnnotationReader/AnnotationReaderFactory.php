...
use Typo3RectorPrefix20210401\Doctrine\Common\Annotations\AnnotationReader;
use Typo3RectorPrefix20210401\Doctrine\Common\Annotations\AnnotationRegistry;
use Typo3RectorPrefix20210401\Doctrine\Common\Annotations\DocParser;
...
final class AnnotationReaderFactory
{
    ...
    private const IGNORED_NAMES = [
        'Typo3RectorPrefix20210401\\ORM\\GeneratedValue',
        'GeneratedValue',
        'Typo3RectorPrefix20210401\\ORM\\InheritanceType',
        'InheritanceType',
        'Typo3RectorPrefix20210401\\ORM\\OrderBy',
        'OrderBy',
        'Typo3RectorPrefix20210401\\ORM\\DiscriminatorMap',
        'DiscriminatorMap',
        'Typo3RectorPrefix20210401\\ORM\\UniqueEntity',
        'UniqueEntity',
        'Typo3RectorPrefix20210401\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'Typo3RectorPrefix20210401\\Gedmo\\Slug',
        'Slug',
        'Typo3RectorPrefix20210401\\Gedmo\\SoftDeleteable',
        'SoftDeleteable',
        'Typo3RectorPrefix20210401\\Gedmo\\Blameable',
        'Blameable',
        'Typo3RectorPrefix20210401\\Gedmo\\Versioned',
        'Versioned',
        // nette @inject dummy annotation
        \Rector\BetterPhpDocParser\ValueObject\PhpDocNode\Nette\NetteInjectTagNode::NAME,
    ];
    public function create() : \Typo3RectorPrefix20210401\Doctrine\Common\Annotations\Reader
    {
        \Typo3RectorPrefix20210401\Doctrine\Common\Annotations\AnnotationRegistry::registerLoader('class_exists');
        // generated
     ...
     */
    private function createAnnotationReader() : \Typo3RectorPrefix20210401\Doctrine\Common\Annotations\Reader
    {
        ...
        return new \Typo3RectorPrefix20210401\Doctrine\Common\Annotations\AnnotationReader(new \Typo3RectorPrefix20210401\Doctrine\Common\Annotations\DocParser());
    }
}
