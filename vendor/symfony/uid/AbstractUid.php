...
abstract class AbstractUid implements \JsonSerializable
{
    ...
    {
        return \strtr(\sprintf('%022s', \Typo3RectorPrefix20210422\Symfony\Component\Uid\BinaryUtil::toBase($this->toBinary(), \Typo3RectorPrefix20210422\Symfony\Component\Uid\BinaryUtil::BASE58)), '0', '1');
    }
    /**
