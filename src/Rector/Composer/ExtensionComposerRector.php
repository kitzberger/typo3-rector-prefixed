...
final class ExtensionComposerRector implements \Ssch\TYPO3Rector\Composer\ExtensionComposerRectorInterface
{
    ...
    public function refactor(\Typo3RectorPrefix20210420\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
...
, [self::TYPO3_VERSION_CONSTRAINT => '^10.4'])]);
    ...
    private function addExtensionKey(\Typo3RectorPrefix20210420\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
        ...
        if (!$fileInfo instanceof \Typo3RectorPrefix20210420\Symplify\SmartFileSystem\SmartFileInfo) {
            return;
        }
        $extra['typo3/cms']['extension-key'] = \basename(\dirname($fileInfo->getRealPath()));
        $composerJson->setExtra($extra);
    }
    private function addDescription(\Typo3RectorPrefix20210420\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function addLicense(\Typo3RectorPrefix20210420\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function fixPackageName(\Typo3RectorPrefix20210420\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
