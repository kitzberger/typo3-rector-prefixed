...
use Typo3RectorPrefix20210315\Doctrine\Common\Persistence\ManagerRegistry as DeprecatedManagerRegistry;
use Typo3RectorPrefix20210315\Doctrine\Common\Persistence\ObjectManager as DeprecatedObjectManager;
use Typo3RectorPrefix20210315\Doctrine\ORM\EntityManagerInterface;
use Typo3RectorPrefix20210315\Doctrine\Persistence\ManagerRegistry;
use Typo3RectorPrefix20210315\Doctrine\Persistence\ObjectManager;
...
final class EntityAliasToClassConstantReferenceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @var string[]
     */
    private const ALLOWED_OBJECT_TYPES = [\Typo3RectorPrefix20210315\Doctrine\ORM\EntityManagerInterface::class, \Typo3RectorPrefix20210315\Doctrine\Persistence\ObjectManager::class, \Typo3RectorPrefix20210315\Doctrine\Common\Persistence\ObjectManager::class, \Typo3RectorPrefix20210315\Doctrine\Persistence\ManagerRegistry::class, \Typo3RectorPrefix20210315\Doctrine\Common\Persistence\ManagerRegistry::class];
    /**
     * @var string[]
     */
...
CODE_SAMPLE
, [self::ALIASES_TO_NAMESPACES => ['App' => 'Typo3RectorPrefix20210315\\App\\Entity']])]);
    }
    /**
     * @return string[]
     */
    ...
    {
        return \Typo3RectorPrefix20210315\Nette\Utils\Strings::contains($name, ':');
    }
