...
final class SetResolver
{
    ...
    public function detectFromName(string $setName) : \Typo3RectorPrefix20210318\Symplify\SmartFileSystem\SmartFileInfo
    {
        $set = $this->setProvider->provideByName($setName);
        if (!$set instanceof \Typo3RectorPrefix20210318\Symplify\SetConfigResolver\ValueObject\Set) {
    ...
    private function reportSetNotFound(string $setName) : void
    {
        ...
        throw new \Typo3RectorPrefix20210318\Symplify\SetConfigResolver\Exception\SetNotFoundException($message, $setName, $this->setProvider->provideSetNames());
    }
}
