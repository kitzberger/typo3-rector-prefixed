...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\Typo3RectorPrefix20210318\Doctrine\Inflector\WordInflector $singularizer, \Typo3RectorPrefix20210318\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => 'Typo3RectorPrefix20210318\\1_\\2', '/([a-z\\d])([A-Z])/' => 'Typo3RectorPrefix20210318\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
...
\class_alias('Typo3RectorPrefix20210318\\Doctrine\\Inflector\\Inflector', 'Doctrine\\Inflector\\Inflector', \false);
