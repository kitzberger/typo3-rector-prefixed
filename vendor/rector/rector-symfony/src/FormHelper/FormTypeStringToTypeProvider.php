...
final class FormTypeStringToTypeProvider
{
    ...
    public function matchClassForNameWithPrefix(string $name) : ?string
    {
        ...
        if (\Typo3RectorPrefix20210423\Nette\Utils\Strings::startsWith($name, 'form.type.')) {
            $name = \Typo3RectorPrefix20210423\Nette\Utils\Strings::substring($name, \strlen('form.type.'));
        }
