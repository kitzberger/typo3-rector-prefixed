...
use Typo3RectorPrefix20210401\Apache_Solr_Document;
use PhpParser\Node;
...
final class ApacheSolrDocumentToSolariumDocumentRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, \Typo3RectorPrefix20210401\Apache_Solr_Document::class)) {
            return null;
        }
