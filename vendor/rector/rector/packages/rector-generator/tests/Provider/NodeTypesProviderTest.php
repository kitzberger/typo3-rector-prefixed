...
final class NodeTypesProviderTest extends \Typo3RectorPrefix20210405\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function test() : void
    {
        ...
        $this->assertContains('Typo3RectorPrefix20210405\\Expr\\New_', $nodeTypes);
