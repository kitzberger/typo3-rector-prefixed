...
use Typo3RectorPrefix20210321\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use Typo3RectorPrefix20210321\Symplify\ComposerJsonManipulator\Json\JsonInliner;
...
use Typo3RectorPrefix20210321\Symplify\SmartFileSystem\Finder\SmartFinder;
...
return static function (\Typo3RectorPrefix20210321\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Typo3RectorPrefix20210321\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\Typo3RectorPrefix20210321\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\Typo3RectorPrefix20210321\Symplify\SmartFileSystem\FileSystemFilter::class);
    $services->set(\Typo3RectorPrefix20210321\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\Typo3RectorPrefix20210321\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Typo3RectorPrefix20210321\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
    $services->set(\Typo3RectorPrefix20210321\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
    $services->set(\Typo3RectorPrefix20210321\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\Typo3RectorPrefix20210321\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\Typo3RectorPrefix20210321\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\Typo3RectorPrefix20210321\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\Typo3RectorPrefix20210321\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
