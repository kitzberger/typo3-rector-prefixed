...
return static function (\Typo3RectorPrefix20210418\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $configuration = [new \Rector\Transform\ValueObject\FuncCallToMethodCall('Typo3RectorPrefix20210418\\GuzzleHttp\\json_decode', 'Typo3RectorPrefix20210418\\GuzzleHttp\\Utils', 'jsonDecode'), new \Rector\Transform\ValueObject\FuncCallToMethodCall('Typo3RectorPrefix20210418\\GuzzleHttp\\get_path', 'Typo3RectorPrefix20210418\\GuzzleHttp\\Utils', 'getPath')];
    ...
    $services->set(\Rector\Transform\Rector\StaticCall\StaticCallToFuncCallRector::class)->call('configure', [[\Rector\Transform\Rector\StaticCall\StaticCallToFuncCallRector::STATIC_CALLS_TO_FUNCTIONS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Transform\ValueObject\StaticCallToFuncCall('Typo3RectorPrefix20210418\\GuzzleHttp\\Utils', 'setPath', 'Typo3RectorPrefix20210418\\GuzzleHttp\\set_path'), new \Rector\Transform\ValueObject\StaticCallToFuncCall('Typo3RectorPrefix20210418\\GuzzleHttp\\Pool', 'batch', 'Typo3RectorPrefix20210418\\GuzzleHttp\\Pool\\batch')])]]);
