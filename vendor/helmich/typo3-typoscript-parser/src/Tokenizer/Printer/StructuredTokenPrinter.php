...
class StructuredTokenPrinter implements \Typo3RectorPrefix20210410\Helmich\TypoScriptParser\Tokenizer\Printer\TokenPrinterInterface
{
    /** @var Yaml */
    private $yaml;
    public function __construct(\Typo3RectorPrefix20210410\Symfony\Component\Yaml\Yaml $yaml = null)
    {
        $this->yaml = $yaml ?: new \Typo3RectorPrefix20210410\Symfony\Component\Yaml\Yaml();
    }
    /**
