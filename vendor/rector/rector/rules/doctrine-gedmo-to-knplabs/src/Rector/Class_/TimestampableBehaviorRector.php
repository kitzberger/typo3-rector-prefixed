...
CODE_SAMPLE
    ...
    {
        if (!$this->classManipulator->hasTrait($node, 'Typo3RectorPrefix20210324\\Gedmo\\Timestampable\\Traits\\TimestampableEntity')) {
            return null;
        }
        $this->classManipulator->replaceTrait($node, 'Typo3RectorPrefix20210324\\Gedmo\\Timestampable\\Traits\\TimestampableEntity', 'Typo3RectorPrefix20210324\\Knp\\DoctrineBehaviors\\Model\\Timestampable\\TimestampableTrait');
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210324\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TimestampableInterface');
        return $node;
    }
}
