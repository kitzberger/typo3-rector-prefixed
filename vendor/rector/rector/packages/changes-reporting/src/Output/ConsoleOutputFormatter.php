...
final class ConsoleOutputFormatter implements \Rector\ChangesReporting\Contract\Output\OutputFormatterInterface
{
    ...
    public function __construct(\Rector\Core\PhpParser\Printer\BetterStandardPrinter $betterStandardPrinter, \Rector\Core\Configuration\Configuration $configuration, \Typo3RectorPrefix20210315\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    private function normalizePathsToRelativeWithLine(string $errorMessage) : string
    {
        ...
        $errorMessage = \Typo3RectorPrefix20210315\Nette\Utils\Strings::replace($errorMessage, $regex, '');
        return $errorMessage = \Typo3RectorPrefix20210315\Nette\Utils\Strings::replace($errorMessage, self::ON_LINE_REGEX, ':');
    }
