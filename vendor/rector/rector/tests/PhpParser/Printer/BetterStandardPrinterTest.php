...
final class BetterStandardPrinterTest extends \Typo3RectorPrefix20210308\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function testAddingCommentOnSomeNodesFail() : void
    {
        ...
        $methodBuilder = new \Typo3RectorPrefix20210308\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('run');
    ...
    {
        (yield ['Typo3RectorPrefix20210308\\Vendor\\Name', "'Vendor\\Name'"]);
        (yield ['Vendor\\', "'Vendor\\\\'"]);
