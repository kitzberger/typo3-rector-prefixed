...
/**
 * @see https://docs.typo3.org/c/typo3/cms-core/master/en-us/Changelog/8.7/Deprecation-80524-PageRepositorygetHashAndPageRepositorystoreHash.html
 */
final class UseCachingFrameworkInsteadGetAndStoreHashRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Use the Caching Framework directly instead of methods PageRepository::getHash and PageRepository::storeHash', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'PHP'
...
PHP
    ...
    private function shouldSkip(\PhpParser\Node $node) : bool
    {
        ...
        return !$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, \TYPO3\CMS\Frontend\Page\PageRepository::class);
    }
    private function createCacheManager() : \PhpParser\Node\Expr\MethodCall
    {
        return $this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall(\TYPO3\CMS\Core\Utility\GeneralUtility::class, 'makeInstance', [$this->nodeFactory->createClassConstReference(\TYPO3\CMS\Core\Cache\CacheManager::class)]), 'getCache', [new \PhpParser\Node\Scalar\String_('cache_hash')]);
    }
}
