...
CODE_SAMPLE
    ...
    {
        $propertyBuilder = new \Typo3RectorPrefix20210316\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder(self::ENVIRONMENT_SERVICE);
    ...
    {
        $paramBuilder = new \Typo3RectorPrefix20210316\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder(self::ENVIRONMENT_SERVICE);
        ...
        $classMethodBuilder = new \Typo3RectorPrefix20210316\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('injectEnvironmentService');
