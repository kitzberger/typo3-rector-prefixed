...
final class ProcessCommand extends \Typo3RectorPrefix20210412\Symfony\Component\Console\Command\Command
{
    ...
    private function resolveReturnCode(\Rector\Core\ValueObject\ProcessResult $processResult) : int
    {
        ...
        return $processResult->getFileDiffs() === [] ? \Typo3RectorPrefix20210412\Symplify\PackageBuilder\Console\ShellCode::SUCCESS : \Typo3RectorPrefix20210412\Symplify\PackageBuilder\Console\ShellCode::ERROR;
    }
    /**
