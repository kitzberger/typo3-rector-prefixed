...
namespace Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\RoutingCaseConverter;
...
use Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface;
...
final class ImportRoutingCaseConverter implements \Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(\Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\NodeFactory\ArgsNodeFactory $argsNodeFactory)
    {
    ...
    {
        $variable = new \PhpParser\Node\Expr\Variable(\Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\ValueObject\VariableName::ROUTING_CONFIGURATOR);
