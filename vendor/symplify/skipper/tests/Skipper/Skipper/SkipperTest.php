...
namespace Typo3RectorPrefix20210422\Symplify\Skipper\Tests\Skipper\Skipper;
...
use Typo3RectorPrefix20210422\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\FifthElement;
use Typo3RectorPrefix20210422\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\SixthSense;
use Typo3RectorPrefix20210422\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\ThreeMan;
use Typo3RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo;
final class SkipperTest extends \Typo3RectorPrefix20210422\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var Skipper
     */
    ...
    {
        $smartFileInfo = new \Typo3RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo($filePath);
    ...
    {
        (yield [\Typo3RectorPrefix20210422\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\ThreeMan::class, \false]);
        (yield [\Typo3RectorPrefix20210422\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\SixthSense::class, \true]);
        (yield [new \Typo3RectorPrefix20210422\Symplify\Skipper\Tests\Skipper\Skipper\Fixture\Element\FifthElement(), \true]);
    }
}
