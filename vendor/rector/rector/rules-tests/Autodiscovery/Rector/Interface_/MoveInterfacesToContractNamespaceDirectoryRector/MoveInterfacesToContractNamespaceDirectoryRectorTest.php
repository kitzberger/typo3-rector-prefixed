...
final class MoveInterfacesToContractNamespaceDirectoryRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
     ...
     */
    public function test(\Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \Rector\FileSystemRector\ValueObject\AddedFileWithContent $expectedAddedFileWithContent) : void
    {
     ...
     */
    public function testSkip(\Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo) : void
    {
        $this->doTestFileInfo($originalFileInfo);
    ...
    public function provideDataSkip() : \Iterator
    {
        ...
        (yield [new \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/Contract/KeepThisSomeInterface.php')]);
        // skip already in correct location
        (yield [new \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/Contract/Foo/KeepThisSomeInterface.php')]);
        // skip nette control factory
        (yield [new \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/Control/ControlFactory.php')]);
        // skip form control factory, even in docblock
        (yield [new \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/Control/FormFactory.php')]);
    }
