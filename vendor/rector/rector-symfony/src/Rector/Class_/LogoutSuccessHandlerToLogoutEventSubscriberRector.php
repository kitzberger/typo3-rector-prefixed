...
final class LogoutSuccessHandlerToLogoutEventSubscriberRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function __construct(\Rector\Symfony\NodeFactory\OnSuccessLogoutClassMethodFactory $onSuccessLogoutClassMethodFactory, \Rector\Symfony\NodeFactory\GetSubscribedEventsClassMethodFactory $getSubscribedEventsClassMethodFactory)
    {
        ...
        $this->successHandlerObjectType = new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210409\\Symfony\\Component\\Security\\Http\\Logout\\LogoutSuccessHandlerInterface');
    }
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $classConstFetch = $this->nodeFactory->createClassConstReference('Typo3RectorPrefix20210409\\Symfony\\Component\\Security\\Http\\Event\\LogoutEvent');
    ...
    {
        $class->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210409\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface');
