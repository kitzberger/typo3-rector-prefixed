...
namespace Typo3RectorPrefix20210316\Symplify\SymplifyKernel\Console;
...
use Typo3RectorPrefix20210316\Symplify\PackageBuilder\Composer\PackageVersionProvider;
...
use Typo3RectorPrefix20210316\Symplify\SymplifyKernel\Strings\StringsConverter;
final class ConsoleApplicationFactory
{
     ...
     */
    public function __construct(array $commands, \Typo3RectorPrefix20210316\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \Typo3RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        $this->commands = $commands;
        $this->stringsConverter = new \Typo3RectorPrefix20210316\Symplify\SymplifyKernel\Strings\StringsConverter();
        $this->parameterProvider = $parameterProvider;
        $this->composerJsonFactory = $composerJsonFactory;
        $this->smartFileSystem = $smartFileSystem;
    }
    public function create() : \Typo3RectorPrefix20210316\Symplify\SymplifyKernel\Console\AutowiredConsoleApplication
    {
        $autowiredConsoleApplication = new \Typo3RectorPrefix20210316\Symplify\SymplifyKernel\Console\AutowiredConsoleApplication($this->commands);
        $this->decorateApplicationWithNameAndVersion($autowiredConsoleApplication);
        return $autowiredConsoleApplication;
    }
    private function decorateApplicationWithNameAndVersion(\Typo3RectorPrefix20210316\Symplify\SymplifyKernel\Console\AutowiredConsoleApplication $autowiredConsoleApplication) : void
    {
        ...
        $packageVersionProvider = new \Typo3RectorPrefix20210316\Symplify\PackageBuilder\Composer\PackageVersionProvider();
