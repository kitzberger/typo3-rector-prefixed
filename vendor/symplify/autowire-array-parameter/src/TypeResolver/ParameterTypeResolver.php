...
namespace Typo3RectorPrefix20210329\Symplify\AutowireArrayParameter\TypeResolver;

use Typo3RectorPrefix20210329\Nette\Utils\Reflection;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\Typo3RectorPrefix20210329\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \Typo3RectorPrefix20210329\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
