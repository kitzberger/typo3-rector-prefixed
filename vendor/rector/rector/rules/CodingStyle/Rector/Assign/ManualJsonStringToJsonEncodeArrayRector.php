...
use Typo3RectorPrefix20210414\Nette\Utils\JsonException;
...
CODE_SAMPLE
    ...
    {
        if (!(bool) \Typo3RectorPrefix20210414\Nette\Utils\Strings::match($stringValue, self::JSON_STRING_REGEX)) {
            return \false;
        }
        try {
            return (bool) \Typo3RectorPrefix20210414\Nette\Utils\Json::decode($stringValue, \Typo3RectorPrefix20210414\Nette\Utils\Json::FORCE_ARRAY);
        } catch (\Typo3RectorPrefix20210414\Nette\Utils\JsonException $jsonException) {
            return \false;
        }
    }
    ...
    {
        $stringValue = \Typo3RectorPrefix20210414\Nette\Utils\Strings::replace($stringValue, self::UNQUOTED_OBJECT_HASH_REGEX, '$1"$2"');
