...
CODE_SAMPLE
, [self::RENAMED_ANNOTATIONS_IN_TYPES => [new \Rector\Renaming\ValueObject\RenameAnnotation('Typo3RectorPrefix20210412\\PHPUnit\\Framework\\TestCase', 'test', 'scenario')]])]);
    }
    /**
    ...
    public function configure(array $configuration) : void
    {
        ...
        \Typo3RectorPrefix20210412\Webmozart\Assert\Assert::allIsInstanceOf($renamedAnnotationsInTypes, \Rector\Renaming\ValueObject\RenameAnnotation::class);
