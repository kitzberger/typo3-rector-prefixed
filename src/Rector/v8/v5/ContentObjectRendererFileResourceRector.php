...
final class ContentObjectRendererFileResourceRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Migrate fileResource method of class ContentObjectRenderer', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'PHP'
...
PHP
    ...
    {
        if ($this->isObjectType($node->var, \TYPO3\CMS\Frontend\ContentObject\ContentObjectRenderer::class)) {
            return \false;
        }
