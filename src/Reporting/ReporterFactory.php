...
final class ReporterFactory
{
    ...
    public function __construct(\Typo3RectorPrefix20210418\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Typo3RectorPrefix20210418\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\ChangesReporting\Annotation\AnnotationExtractor $annotationExtractor, \Rector\Core\Provider\CurrentFileProvider $currentFileProvider)
    {
    ...
    public function createReporter() : \Ssch\TYPO3Rector\Reporting\Reporter
    {
        ...
        $reportFile = new \Typo3RectorPrefix20210418\Symplify\SmartFileSystem\SmartFileInfo(\rtrim($reportDirectory, '/') . '/index.html');
