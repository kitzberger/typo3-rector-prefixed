...
class TokenStream implements \Iterator, \ArrayAccess
{
     ...
     */
    public function current(int $lookAhead = 0) : \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\TokenInterface
    {
     ...
     * @return TokenInterface
     */
    public function offsetGet($offset) : \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\TokenInterface
    {
     ...
     * @return TokenStream
     */
    public function normalized() : \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Parser\TokenStream
    {
        $filteredTokens = [];
        $maxLine = 0;
        foreach ($this->tokens as $token) {
            ...
            if ($token->getType() === \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE) {
                $value = \trim($token->getValue(), "\t ");
                if (\strlen($value) > 0) {
                    $filteredTokens[] = new \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\Token(\Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE, $value, $token->getLine(), $token->getColumn());
                }
            } else {
        ...
        $filteredTokens[] = new \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\Token(\Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE, "\n", $maxLine + 1, 1);
        $filteredTokens[] = new \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\Token(\Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE, "\n", $maxLine + 2, 1);
        return new \Typo3RectorPrefix20210402\Helmich\TypoScriptParser\Parser\TokenStream($filteredTokens);
    }
}
