 ...
 *         class: Other <---
 */
final class ClassServiceCaseConverter implements \Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    {
        $args = $this->argsNodeFactory->createFromValues([$key, $values[\Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]]);
        $setMethodCall = new \PhpParser\Node\Expr\MethodCall(new \PhpParser\Node\Expr\Variable(\Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
        unset($values[\Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !isset($values[\Typo3RectorPrefix20210302\Symplify\PhpConfigPrinter\ValueObject\YamlKey::ALIAS]);
    }
}
