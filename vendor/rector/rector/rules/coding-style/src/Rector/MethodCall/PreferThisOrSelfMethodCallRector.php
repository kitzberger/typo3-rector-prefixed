...
CODE_SAMPLE
, [self::TYPE_TO_PREFERENCE => ['Typo3RectorPrefix20210401\\PHPUnit\\Framework\\TestCase' => self::PREFER_SELF]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function configure(array $configuration) : void
    {
        ...
        \Typo3RectorPrefix20210401\Webmozart\Assert\Assert::allString($typeToPreference);
