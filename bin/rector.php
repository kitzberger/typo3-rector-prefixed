...
use Typo3RectorPrefix20210415\Tracy\Debugger;
...
$autoloadIncluder = new \Typo3RectorPrefix20210415\AutoloadIncluder();
$autoloadIncluder->includeDependencyOrRepositoryVendorAutoloadIfExists();
$autoloadIncluder->loadIfExistsAndNotLoadedYet(__DIR__ . '/../vendor/scoper-autoload.php');
$autoloadIncluder->autoloadProjectAutoloaderFile();
$autoloadIncluder->autoloadFromCommandLine();
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \Typo3RectorPrefix20210415\Symplify\PackageBuilder\Reflection\PrivatesCaller());
$symfonyStyle = $symfonyStyleFactory->create();
$rectorConfigsResolver = new \Rector\Core\Bootstrap\RectorConfigsResolver();
// for simpler debugging output
if (\class_exists(\Typo3RectorPrefix20210415\Tracy\Debugger::class)) {
    \Typo3RectorPrefix20210415\Tracy\Debugger::$maxDepth = 2;
}
try {
    $bootstrapConfigs = $rectorConfigsResolver->provide();
    $configFileInfos = $bootstrapConfigs->getConfigFileInfos();
    $configFileInfos[] = new \Typo3RectorPrefix20210415\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/../config/config.php');
...
\class_alias('Typo3RectorPrefix20210415\\AutoloadIncluder', 'AutoloadIncluder', \false);
