...
final class FormatPerservingPrinterTest extends \Typo3RectorPrefix20210302\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var int
     */
    ...
    public function testFileModeIsPreserved() : void
    {
        ...
        $fileInfo = new \Typo3RectorPrefix20210302\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/file.php');
