...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\Typo3RectorPrefix20210402\Nette\Utils\Strings::endsWith($shortClassName, 'Type')) {
            $shortClassName = (string) \Typo3RectorPrefix20210402\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
    ...
    private function isObjectMethodNameMatch(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if (!$this->isObjectType($classMethod, 'Typo3RectorPrefix20210402\\Symfony\\Component\\Form\\AbstractType')) {
            return \false;
        }
