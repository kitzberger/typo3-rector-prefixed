 ...
 */
class HtmlDumper extends \Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     * {@inheritdoc}
     */
    public function dump(\Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, array $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, bool $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \Typo3RectorPrefix20210329\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
