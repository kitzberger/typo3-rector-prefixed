...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\Typo3RectorPrefix20210415\Nette\Utils\Strings::endsWith($shortClassName, 'Type')) {
            $shortClassName = (string) \Typo3RectorPrefix20210415\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
        $stringy = new \Typo3RectorPrefix20210415\Stringy\Stringy($shortClassName);
    ...
    private function isObjectMethodNameMatch(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if (!$this->isObjectType($classMethod, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210415\\Symfony\\Component\\Form\\AbstractType'))) {
            return \false;
        }
