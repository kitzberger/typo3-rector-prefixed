...
class TypoScriptFrontendController
{
    ...
    public function __construct()
    {
        ...
        $this->tmpl = new \TYPO3\CMS\Core\TypoScript\TemplateService();
        $this->sys_page = new \TYPO3\CMS\Frontend\Page\PageRepository();
        $this->language = new \TYPO3\CMS\Core\Site\Entity\SiteLanguage();
    ...
    public function getLanguage() : \TYPO3\CMS\Core\Site\Entity\SiteLanguage
    {
    ...
    public function initFEuser() : void
    {
    }
    public function storeSessionData() : void
    {
    }
    public function previewInfo() : void
    {
    }
    public function hook_eofe() : void
    {
    }
    public function addTempContentHttpHeaders() : void
    {
    }
