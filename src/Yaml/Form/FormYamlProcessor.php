...
final class FormYamlProcessor implements \Rector\Core\Contract\Processor\FileProcessorInterface
{
    ...
    public function supports(\Rector\Core\ValueObject\Application\File $file) : bool
    {
        ...
        return \Typo3RectorPrefix20210421\Nette\Utils\Strings::endsWith($smartFileInfo->getFilename(), 'form.yaml');
    }
    ...
    {
        $smartFileInfo = $file->getSmartFileInfo();
        $yaml = \Typo3RectorPrefix20210421\Symfony\Component\Yaml\Yaml::parseFile($smartFileInfo->getRealPath());
        if (!\is_array($yaml)) {
            return;
        }
        ...
        $changedContent = \Typo3RectorPrefix20210421\Symfony\Component\Yaml\Yaml::dump($yaml, 99, 2);
