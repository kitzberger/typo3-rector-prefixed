...
final class RouterListToControllerAnnotationsRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function __construct(\Rector\NetteToSymfony\Routing\ExplicitRouteAnnotationDecorator $explicitRouteAnnotationDecorator, \Rector\TypeDeclaration\TypeInferer\ReturnTypeInferer $returnTypeInferer, \Rector\NetteToSymfony\Route\RouteInfoFactory $routeInfoFactory, \Rector\BetterPhpDocParser\ValueObjectFactory\PhpDocNode\Symfony\SymfonyRouteTagValueNodeFactory $symfonyRouteTagValueNodeFactory)
    {
        ...
        $this->routerObjectTypes = [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210410\\Nette\\Application\\IRouter'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210410\\Nette\\Routing\\Router')];
        $this->routeListObjectType = new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210410\\Nette\\Application\\Routers\\RouteList');
    }
...
CODE_SAMPLE
    ...
    private function resolveAssignRouteNodes(\PhpParser\Node\Stmt\ClassMethod $classMethod) : array
    {
        ...
        return $this->betterNodeFinder->find((array) $classMethod->stmts, function (\PhpParser\Node $node) : bool {
            ...
            if ($node->expr instanceof \PhpParser\Node\Expr\StaticCall) {
                ...
                return $this->nodeTypeResolver->isObjectType($node->expr, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210410\\Nette\\Application\\IRouter'));
            }
            return \false;
        });
    }
    ...
    private function shouldSkipClassMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        return $phpDocInfo->hasByAnnotationClass('Typo3RectorPrefix20210410\\Symfony\\Component\\Routing\\Annotation\\Route');
    }
    private function resolvePathFromClassAndMethodNodes(\PhpParser\Node\Stmt\Class_ $class, \PhpParser\Node\Stmt\ClassMethod $classMethod) : string
    {
        ...
        $presenterPart = \Typo3RectorPrefix20210410\Nette\Utils\Strings::after($presenterName, '\\', -1);
        $presenterPart = \Typo3RectorPrefix20210410\Nette\Utils\Strings::substring($presenterPart, 0, -\Typo3RectorPrefix20210410\Nette\Utils\Strings::length('Presenter'));
        $stringy = new \Typo3RectorPrefix20210410\Stringy\Stringy($presenterPart);
        $presenterPart = (string) $stringy->dasherize();
        $match = (array) \Typo3RectorPrefix20210410\Nette\Utils\Strings::match($this->getName($classMethod), self::ACTION_RENDER_NAME_MATCHING_REGEX);
