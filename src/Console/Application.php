...
use Throwable;
final class Application extends \Typo3RectorPrefix20210407\Symfony\Component\Console\Application
{
    /**
     * @var string
     */
    ...
    {
        try {
            $typo3RectorVersion = \Typo3RectorPrefix20210407\Jean85\PrettyVersions::getVersion('ssch/typo3-rector')->getPrettyVersion();
    ...
    public function doRun(\Typo3RectorPrefix20210407\Symfony\Component\Console\Input\InputInterface $input, \Typo3RectorPrefix20210407\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if (!$isXdebugAllowed) {
            $xdebugHandler = new \Typo3RectorPrefix20210407\Composer\XdebugHandler\XdebugHandler('typo3-rector', '--ansi');
            $xdebugHandler->check();
            unset($xdebugHandler);
        }
