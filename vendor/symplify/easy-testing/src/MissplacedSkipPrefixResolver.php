...
use Typo3RectorPrefix20210326\Symplify\EasyTesting\ValueObject\Prefix;
...
final class MissplacedSkipPrefixResolver
{
    ...
    public function resolve(array $fixtureFileInfos) : array
    {
        ...
        foreach ($fixtureFileInfos as $fixtureFileInfo) {
            ...
            $hasSplitLine = (bool) \Typo3RectorPrefix20210326\Nette\Utils\Strings::match($fileContents, \Typo3RectorPrefix20210326\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
    ...
    private function hasNameSkipStart(\Typo3RectorPrefix20210326\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : bool
    {
        return (bool) \Typo3RectorPrefix20210326\Nette\Utils\Strings::match($fixtureFileInfo->getBasenameWithoutSuffix(), \Typo3RectorPrefix20210326\Symplify\EasyTesting\ValueObject\Prefix::SKIP_PREFIX_REGEX);
    }
}
