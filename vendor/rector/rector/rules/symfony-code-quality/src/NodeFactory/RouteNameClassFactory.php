...
final class RouteNameClassFactory
{
    ...
    {
        $classBuilder = new \Typo3RectorPrefix20210308\Symplify\Astral\ValueObject\NodeBuilder\ClassBuilder(\Rector\SymfonyCodeQuality\ValueObject\ClassName::ROUTE_CLASS_SHORT_NAME);
        ...
        $namespaceBuilder = new \Typo3RectorPrefix20210308\Symplify\Astral\ValueObject\NodeBuilder\NamespaceBuilder($namespaceName);
