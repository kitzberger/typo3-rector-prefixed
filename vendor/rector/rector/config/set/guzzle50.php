...
return static function (\Typo3RectorPrefix20210223\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $configuration = [new \Rector\Transform\ValueObject\FuncCallToMethodCall('Typo3RectorPrefix20210223\\GuzzleHttp\\json_decode', 'Typo3RectorPrefix20210223\\GuzzleHttp\\Utils', 'jsonDecode'), new \Rector\Transform\ValueObject\FuncCallToMethodCall('Typo3RectorPrefix20210223\\GuzzleHttp\\get_path', 'Typo3RectorPrefix20210223\\GuzzleHttp\\Utils', 'getPath')];
    ...
    $services->set(\Rector\Transform\Rector\StaticCall\StaticCallToFuncCallRector::class)->call('configure', [[\Rector\Transform\Rector\StaticCall\StaticCallToFuncCallRector::STATIC_CALLS_TO_FUNCTIONS => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Transform\ValueObject\StaticCallToFuncCall('Typo3RectorPrefix20210223\\GuzzleHttp\\Utils', 'setPath', 'Typo3RectorPrefix20210223\\GuzzleHttp\\set_path'), new \Rector\Transform\ValueObject\StaticCallToFuncCall('Typo3RectorPrefix20210223\\GuzzleHttp\\Pool', 'batch', 'Typo3RectorPrefix20210223\\GuzzleHttp\\Pool\\batch')])]]);
    $services->set(\Rector\Renaming\Rector\MethodCall\RenameMethodRector::class)->call('configure', [[\Rector\Renaming\Rector\MethodCall\RenameMethodRector::METHOD_CALL_RENAMES => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Renaming\ValueObject\MethodCallRename('Typo3RectorPrefix20210223\\GuzzleHttp\\Message\\MessageInterface', 'getHeaderLines', 'getHeaderAsArray')])]]);
};
