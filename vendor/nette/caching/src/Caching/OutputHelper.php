...
class OutputHelper
{
    ...
    /** @var string */
    private $key;
    public function __construct(\Typo3RectorPrefix20210412\Nette\Caching\Cache $cache, $key)
    {
        $this->cache = $cache;
        $this->key = $key;
        \ob_start();
    ...
    {
        if ($this->cache === null) {
            throw new \Typo3RectorPrefix20210412\Nette\InvalidStateException('Output cache has already been saved.');
        }
