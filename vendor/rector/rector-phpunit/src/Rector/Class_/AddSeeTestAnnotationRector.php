...
CODE_SAMPLE
    ...
    {
        if (!\Typo3RectorPrefix20210421\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \Typo3RectorPrefix20210421\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
