...
CODE_SAMPLE
    ...
    {
        return !\Typo3RectorPrefix20210409\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\Typo3RectorPrefix20210409\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \Typo3RectorPrefix20210409\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
