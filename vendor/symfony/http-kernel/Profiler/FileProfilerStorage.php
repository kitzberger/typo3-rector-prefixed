 ...
 */
class FileProfilerStorage implements \Typo3RectorPrefix20210323\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\Typo3RectorPrefix20210323\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\Typo3RectorPrefix20210323\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\Typo3RectorPrefix20210323\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \Typo3RectorPrefix20210323\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \Typo3RectorPrefix20210323\Symfony\Component\HttpKernel\Profiler\Profile($token);
