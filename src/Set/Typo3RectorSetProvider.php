...
final class Typo3RectorSetProvider extends \Typo3RectorPrefix20210311\Symplify\SetConfigResolver\Provider\AbstractSetProvider
{
    /**
     * @var string
     ...
     */
    private $sets = [];
    public function __construct(\Typo3RectorPrefix20210311\Symplify\SetConfigResolver\Contract\SetProviderInterface $rectorSetProvider)
    {
