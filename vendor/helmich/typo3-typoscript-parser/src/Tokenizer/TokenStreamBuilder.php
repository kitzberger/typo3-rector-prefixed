...
class TokenStreamBuilder
{
    ...
    public function append(string $type, string $value, int $line, array $patternMatches = []) : void
    {
        ...
        $this->tokens->append(new \Typo3RectorPrefix20210409\Helmich\TypoScriptParser\Tokenizer\Token($type, $value, $line, $this->currentColumn, $patternMatches));
     ...
     * @return void
     */
    public function appendToken(\Typo3RectorPrefix20210409\Helmich\TypoScriptParser\Tokenizer\TokenInterface $token) : void
    {
