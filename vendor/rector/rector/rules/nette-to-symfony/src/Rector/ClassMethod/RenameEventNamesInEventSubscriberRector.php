...
use Typo3RectorPrefix20210323\Composer\Script\Event;
use PhpParser\Node;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($classLike, 'Typo3RectorPrefix20210323\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface')) {
            return null;
        }
