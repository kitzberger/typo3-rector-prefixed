...
final class ReplaceTimeNumberWithDateTimeConstantRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     */
    private const NUMBER_TO_CONSTANT_NAME = [\Typo3RectorPrefix20210412\Nette\Utils\DateTime::HOUR => 'HOUR', \Typo3RectorPrefix20210412\Nette\Utils\DateTime::DAY => 'DAY', \Typo3RectorPrefix20210412\Nette\Utils\DateTime::WEEK => 'WEEK', \Typo3RectorPrefix20210412\Nette\Utils\DateTime::MONTH => 'MONTH', \Typo3RectorPrefix20210412\Nette\Utils\DateTime::YEAR => 'YEAR'];
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        return $this->nodeFactory->createClassConstFetch('Typo3RectorPrefix20210412\\Nette\\Utils\\DateTime', $constantName);
    }
}
