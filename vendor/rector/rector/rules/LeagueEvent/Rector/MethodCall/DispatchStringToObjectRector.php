...
final class DispatchStringToObjectRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Typo3RectorPrefix20210420\\Change string events to anonymous class which implement \\League\\Event\\HasEventName', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function shouldSkip(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if (!$this->nodeTypeResolver->isObjectTypes($methodCall->var, [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210420\\League\\Event\\EventDispatcher'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210420\\League\\Event\\Emitter')])) {
            return \true;
        }
    ...
    {
        $implements = [new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210420\\League\\Event\\HasEventName')];
