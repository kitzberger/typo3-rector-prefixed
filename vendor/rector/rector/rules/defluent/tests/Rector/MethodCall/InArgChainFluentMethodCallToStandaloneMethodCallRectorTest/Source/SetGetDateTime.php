...
final class SetGetDateTime
{
    ...
    public function setDateMin(?\Typo3RectorPrefix20210324\Nette\Utils\DateTime $dateTime = null)
    {
        $this->dateMin = $dateTime;
    }
    public function getDateMin() : ?\Typo3RectorPrefix20210324\Nette\Utils\DateTime
    {
        return $this->dateMin;
    }
}
