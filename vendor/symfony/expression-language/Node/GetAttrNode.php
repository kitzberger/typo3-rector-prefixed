 ...
 * @internal
 */
class GetAttrNode extends \Typo3RectorPrefix20210318\Symfony\Component\ExpressionLanguage\Node\Node
{
    public const PROPERTY_CALL = 1;
    public const METHOD_CALL = 2;
    public const ARRAY_CALL = 3;
    public function __construct(\Typo3RectorPrefix20210318\Symfony\Component\ExpressionLanguage\Node\Node $node, \Typo3RectorPrefix20210318\Symfony\Component\ExpressionLanguage\Node\Node $attribute, \Typo3RectorPrefix20210318\Symfony\Component\ExpressionLanguage\Node\ArrayNode $arguments, int $type)
    {
