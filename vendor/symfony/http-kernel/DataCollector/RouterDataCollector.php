...
use Typo3RectorPrefix20210223\Symfony\Component\HttpFoundation\RedirectResponse;
 ...
 */
class RouterDataCollector extends \Typo3RectorPrefix20210223\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
    ...
    {
        if ($response instanceof \Typo3RectorPrefix20210223\Symfony\Component\HttpFoundation\RedirectResponse) {
    ...
    protected function guessRoute(\Typo3RectorPrefix20210223\Symfony\Component\HttpFoundation\Request $request, $controller)
    {
        return 'n/a';
    }
    /**
