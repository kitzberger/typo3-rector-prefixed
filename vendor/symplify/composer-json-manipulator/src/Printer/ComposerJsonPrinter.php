...
namespace Typo3RectorPrefix20210223\Symplify\ComposerJsonManipulator\Printer;
...
final class ComposerJsonPrinter
{
    ...
    public function printToString(\Typo3RectorPrefix20210223\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : string
    {
     ...
     */
    public function print(\Typo3RectorPrefix20210223\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, $targetFile) : string
    {
        if (\is_string($targetFile)) {
            return $this->jsonFileManager->printComposerJsonToFilePath($composerJson, $targetFile);
        }
        if (!$targetFile instanceof \Typo3RectorPrefix20210223\Symplify\SmartFileSystem\SmartFileInfo) {
