...
use Typo3RectorPrefix20210228\Symplify\PhpConfigPrinter\YamlToPhpConverter;
return static function (\Typo3RectorPrefix20210228\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Typo3RectorPrefix20210228\Symplify\PhpConfigPrinter\YamlToPhpConverter::class);
    $services->set(\Typo3RectorPrefix20210228\Symfony\Component\Yaml\Parser::class);
    $services->set(\Typo3RectorPrefix20210228\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter::class);
};
