...
final class ForwardResponse implements \Typo3RectorPrefix20210317\Psr\Http\Message\ResponseInterface
{
    /**
     * @var string
     */
    ...
    public function withStatus(string $code, string $reasonPhrase = '') : \Typo3RectorPrefix20210317\Psr\Http\Message\ResponseInterface
    {
    }
}
