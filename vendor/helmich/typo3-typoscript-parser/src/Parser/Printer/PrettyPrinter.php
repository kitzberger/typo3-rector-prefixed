...
namespace Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\Printer;
 ...
 */
class PrettyPrinter implements \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface
{
    /**
    ...
    private function printStatementList(array $statements, \Typo3RectorPrefix20210415\Symfony\Component\Console\Output\OutputInterface $output, int $nesting = 0) : void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            if ($statement instanceof \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\AST\NestedAssignment) {
                ...
                $this->printConditionalStatement($output, $nesting, $statement, $next instanceof \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\AST\ConditionalStatement, $previous instanceof \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\AST\ConditionalStatement);
     ...
     */
    private function printConditionalStatement(\Typo3RectorPrefix20210415\Symfony\Component\Console\Output\OutputInterface $output, int $nesting, \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\AST\ConditionalStatement $statement, bool $hasNext = \false, bool $hasPrevious = \false) : void
    {
        if (!$hasPrevious) {
            $output->writeln('');
        }
