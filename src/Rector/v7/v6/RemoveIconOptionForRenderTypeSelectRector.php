...
final class RemoveIconOptionForRenderTypeSelectRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('TCA icon options have been removed', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'PHP'
return [
    'columns' => [
        'foo' => [
            'config' => [
