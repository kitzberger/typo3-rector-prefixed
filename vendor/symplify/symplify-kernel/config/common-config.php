...
use Typo3RectorPrefix20210421\Symplify\SmartFileSystem\Finder\SmartFinder;
...
return static function (\Typo3RectorPrefix20210421\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Typo3RectorPrefix20210421\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    ...
    $services->set(\Typo3RectorPrefix20210421\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\Typo3RectorPrefix20210421\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Typo3RectorPrefix20210421\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
    $services->set(\Typo3RectorPrefix20210421\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
    $services->set(\Typo3RectorPrefix20210421\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\Typo3RectorPrefix20210421\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\Typo3RectorPrefix20210421\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\Typo3RectorPrefix20210421\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\Typo3RectorPrefix20210421\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
