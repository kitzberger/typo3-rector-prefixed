...
use Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Parser\Parser;
...
return static function (\Typo3RectorPrefix20210413\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Ssch\TYPO3Rector\Reporting\Reporter::class)->factory([\Typo3RectorPrefix20210413\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Ssch\TYPO3Rector\Reporting\ReporterFactory::class), 'createReporter']);
    $services->set(\Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Parser\Traverser\Traverser::class);
    $services->set(\Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->alias(\Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Tokenizer\TokenizerInterface::class, \Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->set(\Ssch\TYPO3Rector\TypoScript\Parser\Printer\PrettyPrinter::class);
    $services->alias(\Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface::class, \Ssch\TYPO3Rector\TypoScript\Parser\Printer\PrettyPrinter::class);
    $services->set(\Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->alias(\Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Parser\ParserInterface::class, \Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->set(\Typo3RectorPrefix20210413\Symfony\Component\Console\Output\BufferedOutput::class);
    $services->alias(\Typo3RectorPrefix20210413\Symfony\Component\Console\Output\OutputInterface::class, \Typo3RectorPrefix20210413\Symfony\Component\Console\Output\BufferedOutput::class);
