...
final class StaticRectorStringsTest extends \Typo3RectorPrefix20210323\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertSame($expected, \Rector\Core\Util\StaticRectorStrings::dashesToCamelCase($content));
    }
