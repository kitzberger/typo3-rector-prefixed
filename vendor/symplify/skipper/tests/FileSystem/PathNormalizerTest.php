...
namespace Typo3RectorPrefix20210415\Symplify\Skipper\Tests\FileSystem;

use Iterator;
use Typo3RectorPrefix20210415\Symplify\PackageBuilder\Testing\AbstractKernelTestCase;
use Typo3RectorPrefix20210415\Symplify\Skipper\FileSystem\PathNormalizer;
use Typo3RectorPrefix20210415\Symplify\Skipper\HttpKernel\SkipperKernel;
final class PathNormalizerTest extends \Typo3RectorPrefix20210415\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var PathNormalizer
     */
    ...
    {
        $this->bootKernel(\Typo3RectorPrefix20210415\Symplify\Skipper\HttpKernel\SkipperKernel::class);
        $this->pathNormalizer = $this->getService(\Typo3RectorPrefix20210415\Symplify\Skipper\FileSystem\PathNormalizer::class);
    }
    /**
