...
final class FormatPerservingPrinterTest extends \Typo3RectorPrefix20210326\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var int
     */
    ...
    public function testFileModeIsPreserved() : void
    {
        ...
        $fileInfo = new \Typo3RectorPrefix20210326\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/file.php');
