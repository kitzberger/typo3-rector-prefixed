...
abstract class AbstractSymplifyConsoleApplication extends \Typo3RectorPrefix20210423\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \Typo3RectorPrefix20210423\Symplify\PackageBuilder\Console\Command\CommandNaming();
