...
{
    public function compute(\Typo3RectorPrefix20210412\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : string
    {
    ...
    private function ensureIsPhp(\Typo3RectorPrefix20210412\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    private function createFileLoader(\Typo3RectorPrefix20210412\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, \Typo3RectorPrefix20210412\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \Typo3RectorPrefix20210412\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \Typo3RectorPrefix20210412\Symfony\Component\Config\FileLocator([$fileInfo->getPath()]);
        $fileLoaders = [new \Typo3RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \Typo3RectorPrefix20210412\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \Typo3RectorPrefix20210412\Symfony\Component\Config\Loader\LoaderResolver($fileLoaders);
