...
use Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory;
...
final class ContainerConfiguratorReturnClosureFactory
{
     ...
     */
    public function __construct(\Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory $configuratorClosureNodeFactory, array $caseConverters, \Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\NodeFactory\ContainerNestedNodesFactory $containerNestedNodesFactory)
    {
    ...
    {
        if ($key === \Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES) {
            $nodes[] = $this->createInitializeAssign(\Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES, \Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\ValueObject\MethodName::SERVICES);
        }
        if ($key === \Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS) {
            $nodes[] = $this->createInitializeAssign(\Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\ValueObject\VariableName::PARAMETERS, \Typo3RectorPrefix20210223\Symplify\PhpConfigPrinter\ValueObject\MethodName::PARAMETERS);
        }
        return $nodes;
    }
    /**
