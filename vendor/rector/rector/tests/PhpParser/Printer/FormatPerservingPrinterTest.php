...
final class FormatPerservingPrinterTest extends \Typo3RectorPrefix20210318\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var int
     */
    ...
    protected function setUp() : void
    {
        ...
        $this->smartFileSystem = $this->getService(\Typo3RectorPrefix20210318\Symplify\SmartFileSystem\SmartFileSystem::class);
    }
    ...
    public function testFileModeIsPreserved() : void
    {
        ...
        $fileInfo = new \Typo3RectorPrefix20210318\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/file.php');
