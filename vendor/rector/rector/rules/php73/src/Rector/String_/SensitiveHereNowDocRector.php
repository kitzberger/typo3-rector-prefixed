...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!\Typo3RectorPrefix20210401\Nette\Utils\Strings::contains($node->value, $docLabel)) {
            return null;
        }
    ...
    private function uniquateDocLabel(string $value, string $docLabel) : string
    {
        ...
        $i = 0;
        while (\Typo3RectorPrefix20210401\Nette\Utils\Strings::contains($value, $docLabel)) {
