...
CODE_SAMPLE
    ...
    private function isClassAndMethodMatch(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if ($this->isObjectType($classLike, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210418\\Symfony\\Component\\Form\\AbstractType'))) {
            return $this->isName($classMethod->name, 'getParent');
        }
        if ($this->isObjectType($classMethod, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210418\\Symfony\\Component\\Form\\AbstractTypeExtension'))) {
