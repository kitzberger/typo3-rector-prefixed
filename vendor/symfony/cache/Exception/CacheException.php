...
if (\interface_exists(\Typo3RectorPrefix20210311\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \Typo3RectorPrefix20210311\Psr\Cache\CacheException, \Typo3RectorPrefix20210311\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \Typo3RectorPrefix20210311\Psr\Cache\CacheException
    {
    }
}
