 ...
 */
class ContainerControllerResolver extends \Typo3RectorPrefix20210418\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    ...
    {
        if ($this->container instanceof \Typo3RectorPrefix20210418\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
