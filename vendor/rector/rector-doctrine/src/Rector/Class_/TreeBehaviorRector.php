...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $doctrineAnnotationTagValueNode = $phpDocInfo->getByAnnotationClass('Typo3RectorPrefix20210412\\Gedmo\\Mapping\\Annotation\\Tree');
        if (!$doctrineAnnotationTagValueNode instanceof \Rector\BetterPhpDocParser\PhpDoc\DoctrineAnnotationTagValueNode) {
            return null;
        }
        // we're in a tree entity
        $this->phpDocTagRemover->removeTagValueFromNode($phpDocInfo, $doctrineAnnotationTagValueNode);
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210412\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TreeNodeInterface');
        $this->classInsertManipulator->addAsFirstTrait($node, 'Typo3RectorPrefix20210412\\Knp\\DoctrineBehaviors\\Model\\Tree\\TreeNodeTrait');
    ...
    {
        return $phpDocInfo->hasByAnnotationClasses(['Typo3RectorPrefix20210412\\Gedmo\\Mapping\\Annotation\\TreeLeft', 'Typo3RectorPrefix20210412\\Gedmo\\Mapping\\Annotation\\TreeRight', 'Typo3RectorPrefix20210412\\Gedmo\\Mapping\\Annotation\\TreeRoot', 'Typo3RectorPrefix20210412\\Gedmo\\Mapping\\Annotation\\TreeParent', 'Typo3RectorPrefix20210412\\Gedmo\\Mapping\\Annotation\\TreeLevel']);
    }
    /**
