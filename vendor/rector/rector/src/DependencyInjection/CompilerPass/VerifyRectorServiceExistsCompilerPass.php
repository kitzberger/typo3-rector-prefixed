...
final class VerifyRectorServiceExistsCompilerPass implements \Typo3RectorPrefix20210409\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\Typo3RectorPrefix20210409\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\Typo3RectorPrefix20210409\Nette\Utils\Strings::endsWith($class, 'Rector')) {
                continue;
            }
