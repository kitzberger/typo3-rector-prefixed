...
final class InjectEnvironmentServiceIfNeededInResponseRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->isObjectType($node, \TYPO3\CMS\Extbase\Mvc\Web\Response::class)) {
            return null;
        }
...
CODE_SAMPLE
    ...
    {
        $propertyBuilder = new \Typo3RectorPrefix20210324\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder(self::ENVIRONMENT_SERVICE);
    ...
    {
        $paramBuilder = new \Typo3RectorPrefix20210324\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder(self::ENVIRONMENT_SERVICE);
        ...
        $classMethodBuilder = new \Typo3RectorPrefix20210324\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('injectEnvironmentService');
