...
use Typo3RectorPrefix20210412\Apache_Solr_Document;
use PhpParser\Node;
...
final class ApacheSolrDocumentToSolariumDocumentRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, new \PHPStan\Type\ObjectType(\Typo3RectorPrefix20210412\Apache_Solr_Document::class))) {
            return null;
        }
