...
use Typo3RectorPrefix20210402\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter;
...
final class ComposerProcessor
{
    ...
    public function __construct(\Typo3RectorPrefix20210402\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \Typo3RectorPrefix20210402\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter $composerJsonPrinter, \Rector\Core\Configuration\Configuration $configuration, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector, \Typo3RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Composer\Modifier\ComposerModifier $composerModifier)
    {
    ...
    public function process(string $composerJsonFilePath) : void
    {
        ...
        $smartFileInfo = new \Typo3RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo($composerJsonFilePath);
    ...
    private function addComposerJsonFileDiff(\Typo3RectorPrefix20210402\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $oldComposerJson, \Typo3RectorPrefix20210402\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $newComposerJson, \Typo3RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    private function reportFileContentChange(\Typo3RectorPrefix20210402\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \Typo3RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        if ($this->configuration->isDryRun()) {
            return;
        }
        $this->composerJsonPrinter->print($composerJson, $smartFileInfo);
        $process = new \Typo3RectorPrefix20210402\Symfony\Component\Process\Process(\explode(' ', self::COMPOSER_UPDATE), \getcwd());
