...
use Typo3RectorPrefix20210415\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($this->isObjectType($expr, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210415\\Symfony\\Component\\Process\\Process'))) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210415\\Symfony\\Component\\Console\\Helper\\ProcessHelper'))) {
    ...
    {
        $privatesCaller = new \Typo3RectorPrefix20210415\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \Typo3RectorPrefix20210415\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
