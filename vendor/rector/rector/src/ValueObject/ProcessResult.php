...
final class ProcessResult
{
    ...
    {
        \Typo3RectorPrefix20210420\Webmozart\Assert\Assert::allIsAOf($fileDiffs, \Rector\Core\ValueObject\Reporting\FileDiff::class);
        \Typo3RectorPrefix20210420\Webmozart\Assert\Assert::allIsAOf($errors, \Rector\Core\ValueObject\Application\RectorError::class);
