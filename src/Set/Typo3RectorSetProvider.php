...
use ReflectionClass;
use Typo3RectorPrefix20210223\Symplify\SetConfigResolver\Contract\SetProviderInterface;
use Typo3RectorPrefix20210223\Symplify\SetConfigResolver\Exception\SetNotFoundException;
use Typo3RectorPrefix20210223\Symplify\SetConfigResolver\Provider\AbstractSetProvider;
use Typo3RectorPrefix20210223\Symplify\SetConfigResolver\ValueObject\Set;
use Typo3RectorPrefix20210223\Symplify\SmartFileSystem\SmartFileInfo;
final class Typo3RectorSetProvider extends \Typo3RectorPrefix20210223\Symplify\SetConfigResolver\Provider\AbstractSetProvider
{
    /**
     * @var string
     ...
     */
    private $sets = [];
    public function __construct(\Typo3RectorPrefix20210223\Symplify\SetConfigResolver\Contract\SetProviderInterface $rectorSetProvider)
    {
    ...
    public function provideByName(string $desiredSetName) : ?\Typo3RectorPrefix20210223\Symplify\SetConfigResolver\ValueObject\Set
    {
        try {
            $foundSet = parent::provideByName($desiredSetName);
            if ($foundSet instanceof \Typo3RectorPrefix20210223\Symplify\SetConfigResolver\ValueObject\Set) {
                return $foundSet;
            }
            ...
            foreach ($this->sets as $set) {
                ...
                $desiredSetFileInfo = new \Typo3RectorPrefix20210223\Symplify\SmartFileSystem\SmartFileInfo($desiredSetName);
            ...
            throw new \Typo3RectorPrefix20210223\Symplify\SetConfigResolver\Exception\SetNotFoundException($message, $desiredSetName, $this->provideSetNames());
    ...
    private function hydrateSetsFromConstants(\ReflectionClass $setListReflectionClass) : void
    {
        foreach ($setListReflectionClass->getConstants() as $name => $setPath) {
            ...
            $setName = \Typo3RectorPrefix20210223\Nette\Utils\Strings::replace($setName, self::DASH_NUMBER_REGEX, '$1');
            $this->sets[] = new \Typo3RectorPrefix20210223\Symplify\SetConfigResolver\ValueObject\Set($setName, new \Typo3RectorPrefix20210223\Symplify\SmartFileSystem\SmartFileInfo($setPath));
        }
    }
}
