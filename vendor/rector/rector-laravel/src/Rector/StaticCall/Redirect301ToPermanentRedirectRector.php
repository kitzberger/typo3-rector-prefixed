...
final class Redirect301ToPermanentRedirectRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->routerObjectTypes = [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210411\\Illuminate\\Support\\Facades\\Route'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210411\\Illuminate\\Routing\\Route')];
    }
