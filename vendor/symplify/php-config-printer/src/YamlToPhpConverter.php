...
namespace Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter;
...
use Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory;
use Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory;
use Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter;
use Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter;
/**
...
final class YamlToPhpConverter
{
    ...
    public function __construct(\Typo3RectorPrefix20210329\Symfony\Component\Yaml\Parser $yamlParser, \Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $returnClosureNodesFactory, \Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory $routingConfiguratorReturnClosureFactory, \Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider, \Typo3RectorPrefix20210329\Symplify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter $checkerServiceParametersShifter)
    {
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \Typo3RectorPrefix20210329\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \Typo3RectorPrefix20210329\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
