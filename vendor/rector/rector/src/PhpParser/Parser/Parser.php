...
final class Parser
{
    ...
    public function __construct(\PhpParser\Parser $nikicParser, \Typo3RectorPrefix20210418\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
     ...
     * @return Stmt[]
     */
    public function parseFileInfo(\Typo3RectorPrefix20210418\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
