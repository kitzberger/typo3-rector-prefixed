...
{
    protected function assertFileWasNotChanged(\Typo3RectorPrefix20210421\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    protected function assertFileWasRemoved(\Typo3RectorPrefix20210421\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
    ...
    {
        \Typo3RectorPrefix20210421\Webmozart\Assert\Assert::allIsAOf($expectedAddedFileWithContents, \Rector\FileSystemRector\ValueObject\AddedFileWithContent::class);
        ...
        \Typo3RectorPrefix20210421\Webmozart\Assert\Assert::notEmpty($addedFilePathsWithContents);
