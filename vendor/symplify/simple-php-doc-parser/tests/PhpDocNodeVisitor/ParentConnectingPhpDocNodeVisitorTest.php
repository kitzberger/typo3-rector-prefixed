...
namespace Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\Tests\PhpDocNodeVisitor;
...
use Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\PhpDocNodeTraverser;
use Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\ParentConnectingPhpDocNodeVisitor;
use Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\Tests\HttpKernel\SimplePhpDocParserKernel;
use Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey;
final class ParentConnectingPhpDocNodeVisitorTest extends \Typo3RectorPrefix20210411\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    {
        $this->bootKernel(\Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\Tests\HttpKernel\SimplePhpDocParserKernel::class);
        $this->phpDocNodeTraverser = $this->getService(\Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\PhpDocNodeTraverser::class);
        /** @var ParentConnectingPhpDocNodeVisitor $parentConnectingPhpDocNodeVisitor */
        $parentConnectingPhpDocNodeVisitor = $this->getService(\Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\ParentConnectingPhpDocNodeVisitor::class);
    ...
    public function testChildNode() : void
    {
        ...
        $childParent = $phpDocChildNode->getAttribute(\Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
    ...
    public function testTypeNode() : void
    {
        ...
        $returnParent = $returnTagValueNode->getAttribute(\Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
        $this->assertSame($phpDocChildNode, $returnParent);
        $returnTypeParent = $returnTagValueNode->type->getAttribute(\Typo3RectorPrefix20210411\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
