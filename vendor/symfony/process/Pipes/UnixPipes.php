 ...
 * @internal
 */
class UnixPipes extends \Typo3RectorPrefix20210227\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $ttyMode;
    private $ptyMode;
    ...
    public function getDescriptors() : array
    {
        ...
        if ($this->ptyMode && \Typo3RectorPrefix20210227\Symfony\Component\Process\Process::isPtySupported()) {
            return [['pty'], ['pty'], ['pty']];
        }
        return [
            ['pipe', 'r'],
    ...
    public function readAndWrite(bool $blocking, bool $close = \false) : array
    {
        ...
        if (($r || $w) && \false === \stream_select($r, $w, $e, 0, $blocking ? \Typo3RectorPrefix20210227\Symfony\Component\Process\Process::TIMEOUT_PRECISION * 1000000.0 : 0)) {
