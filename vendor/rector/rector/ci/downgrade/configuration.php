...
final class DowngradeRectorConfig
{
     ...
     */
    public const RECTOR_EXCLUDE_PATHS = ['*/tests/*', __DIR__ . '/../../packages/rector-generator/templates/*', __DIR__ . '/../../vendor/*', __DIR__ . '/../../ci/*', __DIR__ . '/../../stubs/*'];
}
/**
 * Configuration consts for the different rector.php config files
 */
\class_alias('Typo3RectorPrefix20210321\\DowngradeRectorConfig', 'DowngradeRectorConfig', \false);
