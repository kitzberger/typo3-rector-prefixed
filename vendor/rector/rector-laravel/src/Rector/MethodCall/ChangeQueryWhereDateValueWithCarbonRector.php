...
CODE_SAMPLE
    ...
    {
        if (!$this->isOnClassMethodCall($methodCall, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210414\\Illuminate\\Database\\Query\\Builder'), 'whereDate')) {
            return null;
        }
    ...
    private function isCarbonTodayStaticCall(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        $carbonObjectType = new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210414\\Carbon\\Carbon');
