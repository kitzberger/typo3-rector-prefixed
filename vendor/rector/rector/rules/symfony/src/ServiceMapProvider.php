...
final class ServiceMapProvider
{
    ...
    public function __construct(\Typo3RectorPrefix20210326\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Typo3RectorPrefix20210326\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \Typo3RectorPrefix20210326\Nette\Utils\Json::decode(\Typo3RectorPrefix20210326\Nette\Utils\Json::encode((array) $simpleXMLElement), \Typo3RectorPrefix20210326\Nette\Utils\Json::FORCE_ARRAY);
