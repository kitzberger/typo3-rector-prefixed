...
abstract class AbstractSymplifyConsoleApplication extends \Typo3RectorPrefix20210407\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \Typo3RectorPrefix20210407\Symplify\PackageBuilder\Console\Command\CommandNaming();
