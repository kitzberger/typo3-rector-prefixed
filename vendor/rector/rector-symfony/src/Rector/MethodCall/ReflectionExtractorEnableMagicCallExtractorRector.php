...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($methodCall->var, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210414\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor'))) {
            return \true;
        }
    ...
    {
        $magicGetClassConstFetch = $this->nodeFactory->createClassConstFetch('Typo3RectorPrefix20210414\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_GET');
        $magicSetClassConstFetch = $this->nodeFactory->createClassConstFetch('Typo3RectorPrefix20210414\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_SET');
        ...
        $magicCallClassConstFetch = $this->nodeFactory->createClassConstFetch('Typo3RectorPrefix20210414\\Symfony\\Component\\PropertyInfo\\Extractor\\ReflectionExtractor', 'MAGIC_CALL');
