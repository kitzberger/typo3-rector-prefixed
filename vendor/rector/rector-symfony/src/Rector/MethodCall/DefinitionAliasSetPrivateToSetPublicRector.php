...
final class DefinitionAliasSetPrivateToSetPublicRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->definitionObjectTypes = [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210409\\Symfony\\Component\\DependencyInjection\\Alias'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210409\\Symfony\\Component\\DependencyInjection\\Definition')];
    }
