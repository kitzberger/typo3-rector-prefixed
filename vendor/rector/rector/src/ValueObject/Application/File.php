...
final class File
{
    ...
    public function __construct(\Typo3RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $fileContent)
    {
        $this->smartFileInfo = $smartFileInfo;
        $this->fileContent = $fileContent;
        $this->originalFileContent = $fileContent;
    }
    public function getSmartFileInfo() : \Typo3RectorPrefix20210422\Symplify\SmartFileSystem\SmartFileInfo
    {
