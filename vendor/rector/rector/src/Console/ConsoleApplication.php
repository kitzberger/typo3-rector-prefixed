...
final class ConsoleApplication extends \Typo3RectorPrefix20210409\Symfony\Component\Console\Application
{
    /**
     * @var string
     */
    ...
    public function __construct(\Rector\Core\Configuration\Configuration $configuration, \Typo3RectorPrefix20210409\Symplify\PackageBuilder\Console\Command\CommandNaming $commandNaming, array $commands = [])
    {
        ...
        $this->setDefaultCommand(\Typo3RectorPrefix20210409\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\Rector\Core\Console\Command\ProcessCommand::class));
    }
    public function doRun(\Typo3RectorPrefix20210409\Symfony\Component\Console\Input\InputInterface $input, \Typo3RectorPrefix20210409\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if (!$isXdebugAllowed) {
            $xdebugHandler = new \Typo3RectorPrefix20210409\Composer\XdebugHandler\XdebugHandler('rector', '--ansi');
            $xdebugHandler->check();
            unset($xdebugHandler);
        }
