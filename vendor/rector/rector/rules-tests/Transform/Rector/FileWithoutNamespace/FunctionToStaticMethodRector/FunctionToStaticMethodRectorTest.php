...
final class FunctionToStaticMethodRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    public function test(\Typo3RectorPrefix20210415\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        ...
        $addedFileWithContent = new \Rector\FileSystemRector\ValueObject\AddedFileWithContent($this->originalTempFileInfo->getRealPathDirectory() . '/StaticFunctions.php', \Typo3RectorPrefix20210415\Nette\Utils\FileSystem::read(__DIR__ . '/Source/ExpectedStaticFunctions.php'));
