...
class MultilineTokenBuilder
{
     ...
     */
    public function endMultilineToken(string $append = '') : \Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Tokenizer\TokenInterface
    {
        ...
        if ($type === null || $startLine === null || $startColumn === null) {
            throw new \Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Tokenizer\TokenizerException('cannot call "endMultilineToken" before calling "startMultilineToken"');
        }
        $token = new \Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Tokenizer\Token($type, \rtrim($value), $startLine, $startColumn);
        $this->reset();
        return $token;
    }
    /**
