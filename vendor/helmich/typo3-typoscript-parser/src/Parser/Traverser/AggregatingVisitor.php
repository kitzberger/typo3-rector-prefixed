 ...
 */
class AggregatingVisitor implements \Typo3RectorPrefix20210421\Helmich\TypoScriptParser\Parser\Traverser\Visitor
{
    /** @var Visitor[] */
    private $visitors = [];
    /**
     ...
     * @return void
     */
    public function exitNode(\Typo3RectorPrefix20210421\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        foreach ($this->visitors as $visitor) {
