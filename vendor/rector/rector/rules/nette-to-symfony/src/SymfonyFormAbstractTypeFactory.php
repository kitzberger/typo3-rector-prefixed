...
final class SymfonyFormAbstractTypeFactory
{
    ...
    public function createFromNetteFormMethodCalls(array $methodCalls) : \PhpParser\Node\Stmt\Class_
    {
        ...
        $buildFormClassMethod->params[] = new \PhpParser\Node\Param($formBuilderVariable, null, new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210324\\Symfony\\Component\\Form\\FormBuilderInterface'));
    ...
    private function createBuildFormMethodCalls(array $methodCalls, \PhpParser\Node\Expr\Variable $formBuilderVariable) : array
    {
        ...
        foreach ($methodCalls as $methodCall) {
            if ($this->nodeNameResolver->isName($methodCall->name, 'addText')) {
                ...
                $formTypeClassConstant = $this->nodeFactory->createClassConstReference(\Typo3RectorPrefix20210324\Symfony\Component\Form\Extension\Core\Type\TextType::class);
