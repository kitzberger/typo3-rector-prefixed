 ...
 */
class RequestMatcher implements \Typo3RectorPrefix20210409\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\Typo3RectorPrefix20210409\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\Typo3RectorPrefix20210409\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
