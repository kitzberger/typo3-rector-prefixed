...
final class FormatPerservingPrinterTest extends \Typo3RectorPrefix20210402\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var int
     */
    ...
    public function testFileModeIsPreserved() : void
    {
        ...
        $fileInfo = new \Typo3RectorPrefix20210402\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/file.php');
