...
final class UseImportsAdder
{
    ...
    {
        $afterCurrentNamespace = \Typo3RectorPrefix20210331\Nette\Utils\Strings::after($objectType->getClassName(), $namespaceName . '\\');
        if (!$afterCurrentNamespace) {
            return \false;
        }
        return !\Typo3RectorPrefix20210331\Nette\Utils\Strings::contains($afterCurrentNamespace, '\\');
    }
}
