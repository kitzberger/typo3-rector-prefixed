...
CODE_SAMPLE
    ...
    private function resolveMethodNameFromKdybyEventName(\PhpParser\Node\Expr $expr) : string
    {
        ...
        if (\Typo3RectorPrefix20210316\Nette\Utils\Strings::contains($kdybyEventName, '::')) {
            return (string) \Typo3RectorPrefix20210316\Nette\Utils\Strings::after($kdybyEventName, '::', -1);
        }
