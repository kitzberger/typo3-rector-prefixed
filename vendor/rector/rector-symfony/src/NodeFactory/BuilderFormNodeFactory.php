...
final class BuilderFormNodeFactory
{
    ...
    public function create(\PhpParser\Node\Stmt\ClassMethod $constructorClassMethod) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $classMethodBuilder = new \Typo3RectorPrefix20210420\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('buildForm');
    ...
    {
        $optionsParamBuilder = new \Typo3RectorPrefix20210420\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('options');
