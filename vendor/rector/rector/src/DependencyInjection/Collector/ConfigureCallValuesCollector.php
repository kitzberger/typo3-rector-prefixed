...
final class ConfigureCallValuesCollector
{
    ...
    public function collectFromServiceAndClassName(string $className, \Typo3RectorPrefix20210316\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
