...
final class GenerateCommand extends \Typo3RectorPrefix20210324\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\RuleDocGenerator\ValueObject\Option::PATHS, \Typo3RectorPrefix20210324\Symfony\Component\Console\Input\InputArgument::REQUIRED | \Typo3RectorPrefix20210324\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to directory of your project');
        $this->addOption(\Symplify\RuleDocGenerator\ValueObject\Option::OUTPUT_FILE, null, \Typo3RectorPrefix20210324\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to output generated markdown file', \getcwd() . '/docs/rules_overview.md');
        $this->addOption(\Symplify\RuleDocGenerator\ValueObject\Option::CATEGORIZE, null, \Typo3RectorPrefix20210324\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Group in categories');
    }
    protected function execute(\Typo3RectorPrefix20210324\Symfony\Component\Console\Input\InputInterface $input, \Typo3RectorPrefix20210324\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $outputFileInfo = new \Typo3RectorPrefix20210324\Symplify\SmartFileSystem\SmartFileInfo($outputFilePath);
