...
use Typo3RectorPrefix20210412\Symplify\SetConfigResolver\Config\SetsParameterResolver;
 ...
 */
final class SetAwareConfigResolver extends \Typo3RectorPrefix20210412\Symplify\SetConfigResolver\AbstractConfigResolver
{
    /**
    ...
    {
        $this->setResolver = new \Typo3RectorPrefix20210412\Symplify\SetConfigResolver\SetResolver($setProvider);
        $this->setsParameterResolver = new \Typo3RectorPrefix20210412\Symplify\SetConfigResolver\Config\SetsParameterResolver($this->setResolver);
        parent::__construct();
    }
    /**
