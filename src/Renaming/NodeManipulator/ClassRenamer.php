...
namespace Ssch\TYPO3Rector\Renaming\NodeManipulator;
...
use Typo3RectorPrefix20210326\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser;
...
final class ClassRenamer
{
    ...
    public function __construct(\Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \Typo3RectorPrefix20210326\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\CodingStyle\Naming\ClassNaming $classNaming, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \Rector\BetterPhpDocParser\PhpDocManipulator\PhpDocClassRenamer $phpDocClassRenamer, \Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfoFactory $phpDocInfoFactory, \Rector\NodeTypeResolver\PhpDoc\NodeAnalyzer\DocBlockClassRenamer $docBlockClassRenamer, \PHPStan\Reflection\ReflectionProvider $reflectionProvider, \Rector\NodeRemoval\NodeRemover $nodeRemover, \Typo3RectorPrefix20210326\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    /**
     * Replace types in @var/@param/@return/@throws, Doctrine @ORM entity targetClass, Serialize, Assert etc.
     *
     * @param array<string, string> $oldToNewClasses
     */
    ...
    private function refactorName(\PhpParser\Node\Name $name, array $oldToNewClasses) : ?\PhpParser\Node\Name
    {
        ...
        if ($parentNode instanceof \PhpParser\Node\Stmt\UseUse && (\PhpParser\Node\Stmt\Use_::TYPE_NORMAL === $parentNode->type || \PhpParser\Node\Stmt\Use_::TYPE_UNKNOWN === $parentNode->type)) {
