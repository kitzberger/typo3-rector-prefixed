...
final class FormYamlProcessor implements \Ssch\TYPO3Rector\Processor\ProcessorInterface
{
    ...
    {
        $yaml = \Typo3RectorPrefix20210331\Symfony\Component\Yaml\Yaml::parseFile($smartFileInfo->getRealPath());
        if ([] === $this->transformer) {
        ...
        return \Typo3RectorPrefix20210331\Symfony\Component\Yaml\Yaml::dump($yaml, 99, 2);
    }
