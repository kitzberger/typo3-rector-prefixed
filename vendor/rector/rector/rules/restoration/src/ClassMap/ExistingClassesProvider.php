...
final class ExistingClassesProvider
{
    ...
    public function __construct(\Typo3RectorPrefix20210223\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    private function getPsr4PathFromComposerJson() : array
    {
        ...
        return \Typo3RectorPrefix20210223\Nette\Utils\Arrays::flatten($psr4AndClassmapDirectories);
    }
    /**
