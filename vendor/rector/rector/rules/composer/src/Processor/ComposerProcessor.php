...
final class ComposerProcessor
{
    ...
    public function __construct(\Typo3RectorPrefix20210405\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \Typo3RectorPrefix20210405\Symplify\ComposerJsonManipulator\Printer\ComposerJsonPrinter $composerJsonPrinter, \Rector\Core\Configuration\Configuration $configuration, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector, \Typo3RectorPrefix20210405\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Composer\Modifier\ComposerModifier $composerModifier)
    {
    ...
    public function process(string $composerJsonFilePath) : void
    {
        ...
        $smartFileInfo = new \Typo3RectorPrefix20210405\Symplify\SmartFileSystem\SmartFileInfo($composerJsonFilePath);
    ...
    private function reportFileContentChange(\Typo3RectorPrefix20210405\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \Typo3RectorPrefix20210405\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        ...
        $process = new \Typo3RectorPrefix20210405\Symfony\Component\Process\Process(\explode(' ', self::COMPOSER_UPDATE), \getcwd());
