...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        foreach ($node->getProperties() as $property) {
            ...
            $doctrineAnnotationTagValueNode = $propertyPhpDocInfo->getByAnnotationClass('Typo3RectorPrefix20210412\\Gedmo\\Mapping\\Annotation\\Slug');
        ...
        $this->classInsertManipulator->addAsFirstTrait($node, 'Typo3RectorPrefix20210412\\Knp\\DoctrineBehaviors\\Model\\Sluggable\\SluggableTrait');
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210412\\Knp\\DoctrineBehaviors\\Contract\\Entity\\SluggableInterface');
