...
namespace Typo3RectorPrefix20210412\Symplify\SetConfigResolver\Tests\ConfigResolver;
...
use Typo3RectorPrefix20210412\Symplify\SetConfigResolver\SetAwareConfigResolver;
use Typo3RectorPrefix20210412\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider;
...
final class SetAwareConfigResolverTest extends \Typo3RectorPrefix20210412\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->setAwareConfigResolver = new \Typo3RectorPrefix20210412\Symplify\SetConfigResolver\SetAwareConfigResolver(new \Typo3RectorPrefix20210412\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider());
    }
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \Typo3RectorPrefix20210412\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    {
        $this->expectException(\Typo3RectorPrefix20210412\Symplify\SetConfigResolver\Exception\SetNotFoundException::class);
        $basicConfigFileInfo = new \Typo3RectorPrefix20210412\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/missing_set_config.php');
    ...
    {
        $basicConfigFileInfo = new \Typo3RectorPrefix20210412\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/php_config_with_sets.php');
        ...
        $expectedSetFileInfo = new \Typo3RectorPrefix20210412\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/some_php_set.php');
        $this->assertEquals($expectedSetFileInfo, $setFileInfo);
    }
    public function testMissingFileInInput() : void
    {
        $this->expectException(\Typo3RectorPrefix20210412\Symplify\SmartFileSystem\Exception\FileNotFoundException::class);
        $arrayInput = new \Typo3RectorPrefix20210412\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
