...
namespace Typo3RectorPrefix20210410\Symplify\SetConfigResolver\ValueObject\Bootstrap;
...
final class BootstrapConfigs
{
    ...
    {
        if (!$this->mainConfigFileInfo instanceof \Typo3RectorPrefix20210410\Symplify\SmartFileSystem\SmartFileInfo) {
