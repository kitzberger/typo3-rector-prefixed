...
final class DowngradePathsCommand extends \Typo3RectorPrefix20210422\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OPTION_PHP_VERSION, \Typo3RectorPrefix20210422\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Target PHP version');
    }
    ...
    {
        $finder = new \Typo3RectorPrefix20210422\Symfony\Component\Finder\Finder();
    ...
    {
        foreach ($downgradePaths as $key => $downgradePath) {
            if (!\Typo3RectorPrefix20210422\Nette\Utils\Strings::startsWith($downgradePath, 'vendor/')) {
                continue;
            }
            $downgradePaths[$key] = (string) \Typo3RectorPrefix20210422\Nette\Utils\Strings::before($downgradePath, '/', 2);
        }
