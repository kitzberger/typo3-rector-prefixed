...
namespace Typo3RectorPrefix20210415\Symplify\SimplePhpDocParser\PhpDocNodeVisitor;
 ...
 */
final class ParentConnectingPhpDocNodeVisitor extends \Typo3RectorPrefix20210415\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
     * @var Node[]
     */
    ...
    public function enterNode(\PHPStan\PhpDocParser\Ast\Node $node) : ?\PHPStan\PhpDocParser\Ast\Node
    {
        if ($this->stack !== []) {
            ...
            $node->setAttribute(\Typo3RectorPrefix20210415\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT, $parentNode);
        }
        $this->stack[] = $node;
        return $node;
    }
