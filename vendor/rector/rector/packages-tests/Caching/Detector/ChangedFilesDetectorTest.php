...
final class ChangedFilesDetectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    {
        $smartFileInfo = new \Typo3RectorPrefix20210411\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/file.php');
    ...
    {
        $smartFileInfo = new \Typo3RectorPrefix20210411\Symplify\SmartFileSystem\SmartFileInfo($filePathName);
