...
use Typo3RectorPrefix20210317\Symfony\Component\Form\AbstractType;
use Typo3RectorPrefix20210317\Symfony\Component\Form\Extension\Core\Type\TextType;
use Typo3RectorPrefix20210317\Symfony\Component\Form\FormBuilderInterface;
class SomeFormType extends \Typo3RectorPrefix20210317\Symfony\Component\Form\AbstractType
{
    public function buildForm(\Typo3RectorPrefix20210317\Symfony\Component\Form\FormBuilderInterface $formBuilder, array $options)
    {
        $formBuilder->add('name', \Typo3RectorPrefix20210317\Symfony\Component\Form\Extension\Core\Type\TextType::class, ['label' => 'Your name']);
    }
}
\class_alias('Typo3RectorPrefix20210317\\SomeFormType', 'SomeFormType', \false);
CODE_SAMPLE
)]);
    }
    /**
    ...
    {
        if (!$this->isObjectType($node, 'Typo3RectorPrefix20210317\\Nette\\Application\\UI\\Control')) {
            return null;
        }
    ...
    private function createFormTypeClassFromBuildFormClassMethod(\PhpParser\Node\Stmt\ClassMethod $buildFormClassMethod) : \PhpParser\Node\Stmt\Class_
    {
        ...
        $formTypeClass->extends = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210317\\Symfony\\Component\\Form\\AbstractType');
