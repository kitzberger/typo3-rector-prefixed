...
use Typo3RectorPrefix20210330\Composer\Script\Event;
use PhpParser\Node;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($classLike, 'Typo3RectorPrefix20210330\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface')) {
            return null;
        }
