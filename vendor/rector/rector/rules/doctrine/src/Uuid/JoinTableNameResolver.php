...
final class JoinTableNameResolver
{
    ...
    {
        if (!\Typo3RectorPrefix20210407\Nette\Utils\Strings::contains($currentClass, '\\')) {
            return $currentClass;
        }
        return (string) \Typo3RectorPrefix20210407\Nette\Utils\Strings::after($currentClass, '\\', -1);
    }
}
