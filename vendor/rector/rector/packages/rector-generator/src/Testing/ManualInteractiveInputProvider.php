...
use Typo3RectorPrefix20210321\Symfony\Component\Console\Tester\CommandTester;
...
final class ManualInteractiveInputProvider
{
    ...
    public function __construct(\Typo3RectorPrefix20210321\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Typo3RectorPrefix20210321\Symplify\PackageBuilder\Reflection\PrivatesCaller $privatesCaller, \Typo3RectorPrefix20210321\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor)
    {
    ...
    {
        $arrayInput = new \Typo3RectorPrefix20210321\Symfony\Component\Console\Input\ArrayInput([]);
    ...
    private function createInputStream(array $manualInteractiveInput)
    {
        ...
        return $this->privatesCaller->callPrivateMethod(\Typo3RectorPrefix20210321\Symfony\Component\Console\Tester\CommandTester::class, 'createStream', [$manualInteractiveInput]);
    }
}
