...
CODE_SAMPLE
    ...
    {
        if ($this->isOnClassMethodCall($expr, 'Typo3RectorPrefix20210407\\Nette\\Application\\UI\\Control', 'getComponent')) {
            return \true;
        }
    ...
    private function isArrayDimFetchStringOnControlVariable(\PhpParser\Node\Expr $expr) : bool
    {
        ...
        return \is_a($varStaticType->getClassName(), 'Typo3RectorPrefix20210407\\Nette\\Application\\UI\\Control', \true);
    }
