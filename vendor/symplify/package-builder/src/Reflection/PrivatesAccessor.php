...
use Typo3RectorPrefix20210418\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \Typo3RectorPrefix20210418\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
