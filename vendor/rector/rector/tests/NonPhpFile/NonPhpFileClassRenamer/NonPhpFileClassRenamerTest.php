...
final class NonPhpFileClassRenamerTest extends \Typo3RectorPrefix20210330\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var array<string, string>
     */
    private const CLASS_RENAMES = [
        'Session' => 'Typo3RectorPrefix20210330\\Illuminate\\Support\\Facades\\Session',
        ...
        // Laravel
        'Form' => 'Typo3RectorPrefix20210330\\Collective\\Html\\FormFacade',
        'Html' => 'Typo3RectorPrefix20210330\\Collective\\Html\\HtmlFacade',
    ];
    /**
     ...
     */
    public function test(\Typo3RectorPrefix20210330\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $this->parameterProvider->changeParameter(\Rector\Core\Configuration\Option::AUTO_IMPORT_NAMES, \false);
        $inputAndExpected = \Typo3RectorPrefix20210330\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToInputAndExpected($fixtureFileInfo);
    ...
    {
        return \Typo3RectorPrefix20210330\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory(__DIR__ . '/Fixture', '*');
    }
}
