...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, 'Typo3RectorPrefix20210323\\Illuminate\\Support\\ServiceProvider')) {
            return null;
        }
        ...
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210323\\Illuminate\\Contracts\\Support\\DeferrableProvider');
        return $node;
    }
