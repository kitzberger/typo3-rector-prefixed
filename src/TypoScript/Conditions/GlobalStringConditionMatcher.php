...
final class GlobalStringConditionMatcher implements \Ssch\TYPO3Rector\TypoScript\Conditions\TyposcriptConditionMatcher
{
    ...
    {
        if (\Typo3RectorPrefix20210415\Nette\Utils\Strings::contains($condition, '{$')) {
            return \false;
        }
        return \Typo3RectorPrefix20210415\Nette\Utils\Strings::startsWith($condition, self::TYPE);
    }
