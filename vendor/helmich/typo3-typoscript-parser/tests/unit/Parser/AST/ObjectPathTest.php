...
class ObjectPathTest extends \Typo3RectorPrefix20210412\PHPUnit\Framework\TestCase
{
    public function testPathsRemainStrings()
    {
        $op = new \Typo3RectorPrefix20210412\Helmich\TypoScriptParser\Parser\AST\ObjectPath("foo.0", "0");
        assertThat($op->relativeName, identicalTo("0"));
    }
    public function testIntPathsRaisesTypeError()
    {
        $this->expectException(\TypeError::class);
        new \Typo3RectorPrefix20210412\Helmich\TypoScriptParser\Parser\AST\ObjectPath("foo.0", 0);
    }
}
