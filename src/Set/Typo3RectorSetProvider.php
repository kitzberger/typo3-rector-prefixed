...
use Typo3RectorPrefix20210407\Symplify\SetConfigResolver\Provider\AbstractSetProvider;
...
final class Typo3RectorSetProvider extends \Typo3RectorPrefix20210407\Symplify\SetConfigResolver\Provider\AbstractSetProvider
{
    /**
     * @var string
     ...
     */
    private $sets = [];
    public function __construct(\Typo3RectorPrefix20210407\Symplify\SetConfigResolver\Contract\SetProviderInterface $rectorSetProvider)
    {
    ...
    public function provideByName(string $desiredSetName) : ?\Typo3RectorPrefix20210407\Symplify\SetConfigResolver\ValueObject\Set
    {
        try {
            ...
            if ($foundSet instanceof \Typo3RectorPrefix20210407\Symplify\SetConfigResolver\ValueObject\Set) {
                return $foundSet;
            }
            ...
            foreach ($this->sets as $set) {
                ...
                $desiredSetFileInfo = new \Typo3RectorPrefix20210407\Symplify\SmartFileSystem\SmartFileInfo($desiredSetName);
        ...
        } catch (\Typo3RectorPrefix20210407\Symplify\SetConfigResolver\Exception\SetNotFoundException $setNotFoundException) {
    ...
    private function hydrateSetsFromConstants(\ReflectionClass $setListReflectionClass) : void
    {
        foreach ($setListReflectionClass->getConstants() as $name => $setPath) {
            ...
            $setName = \Typo3RectorPrefix20210407\Nette\Utils\Strings::replace($setName, self::DASH_NUMBER_REGEX, '$1');
            $this->sets[] = new \Typo3RectorPrefix20210407\Symplify\SetConfigResolver\ValueObject\Set($setName, new \Typo3RectorPrefix20210407\Symplify\SmartFileSystem\SmartFileInfo($setPath));
        }
    }
}
