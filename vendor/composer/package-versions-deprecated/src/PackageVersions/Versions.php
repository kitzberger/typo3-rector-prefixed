...
use Typo3RectorPrefix20210302\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\Typo3RectorPrefix20210302\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\Typo3RectorPrefix20210302\Composer\InstalledVersions::class, \false) || !\Typo3RectorPrefix20210302\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \Typo3RectorPrefix20210302\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\Typo3RectorPrefix20210302\Composer\InstalledVersions::class, \false) && \Typo3RectorPrefix20210302\Composer\InstalledVersions::getRawData()) {
            return \Typo3RectorPrefix20210302\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \Typo3RectorPrefix20210302\Composer\InstalledVersions::getReference($packageName);
        }
