...
return static function (\Typo3RectorPrefix20210401\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $parameters->set(\Rector\Core\Configuration\Option::SKIP, \Typo3RectorPrefix20210401\DowngradeRectorConfig::DEPENDENCY_EXCLUDE_PATHS);
    $parameters->set(\Rector\Core\Configuration\Option::SETS, [\Rector\Set\ValueObject\DowngradeSetList::PHP_80, \Rector\Set\ValueObject\DowngradeSetList::PHP_74]);
};
