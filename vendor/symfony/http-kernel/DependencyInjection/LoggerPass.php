...
use Typo3RectorPrefix20210422\Symfony\Component\HttpKernel\Log\Logger;
/**
 * Registers the default logger if necessary.
 *
 * @author Kévin Dunglas <dunglas@gmail.com>
 */
class LoggerPass implements \Typo3RectorPrefix20210422\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    public function process(\Typo3RectorPrefix20210422\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        $container->register('logger', \Typo3RectorPrefix20210422\Symfony\Component\HttpKernel\Log\Logger::class)->setPublic(\false);
    }
}
