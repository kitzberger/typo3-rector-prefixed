...
namespace Typo3RectorPrefix20210329\Symplify\Skipper\Tests\FileSystem;
...
final class PathNormalizerTest extends \Typo3RectorPrefix20210329\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var PathNormalizer
     */
    ...
    {
        $this->bootKernel(\Typo3RectorPrefix20210329\Symplify\Skipper\HttpKernel\SkipperKernel::class);
        $this->pathNormalizer = $this->getService(\Typo3RectorPrefix20210329\Symplify\Skipper\FileSystem\PathNormalizer::class);
    }
    /**
