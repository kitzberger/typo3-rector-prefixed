...
use Typo3RectorPrefix20210228\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if ($this->isObjectType($expr, 'Typo3RectorPrefix20210228\\Symfony\\Component\\Process\\Process')) {
            return $this->processArgumentPosition($node, 0);
        }
        if ($this->isObjectType($expr, 'Typo3RectorPrefix20210228\\Symfony\\Component\\Console\\Helper\\ProcessHelper')) {
    ...
    {
        $privatesCaller = new \Typo3RectorPrefix20210228\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \Typo3RectorPrefix20210228\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
