...
final class LocalPropertyAnalyzer
{
     ...
     * @var string
     */
    private const LARAVEL_COLLECTION_CLASS = 'Typo3RectorPrefix20210405\\Illuminate\\Support\\Collection';
    /**
