...
namespace Typo3RectorPrefix20210308\Symplify\SymplifyKernel\HttpKernel;
...
use Typo3RectorPrefix20210308\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle;
use Typo3RectorPrefix20210308\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \Typo3RectorPrefix20210308\Symfony\Component\HttpKernel\Kernel implements \Typo3RectorPrefix20210308\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \Typo3RectorPrefix20210308\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    public function setConfigs(array $configs) : void
    {
        foreach ($configs as $config) {
            if ($config instanceof \Typo3RectorPrefix20210308\Symplify\SmartFileSystem\SmartFileInfo) {
    ...
    {
        $kernelUniqueHasher = new \Typo3RectorPrefix20210308\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
