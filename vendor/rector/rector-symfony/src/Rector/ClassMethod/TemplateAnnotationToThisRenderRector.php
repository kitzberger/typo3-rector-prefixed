...
final class TemplateAnnotationToThisRenderRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const RESPONSE_CLASS = 'Typo3RectorPrefix20210409\\Symfony\\Component\\HttpFoundation\\Response';
    /**
...
CODE_SAMPLE
    ...
    private function addAbstractControllerParentClassIfMissing(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        $class->extends = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210409\\Symfony\\Bundle\\FrameworkBundle\\Controller\\AbstractController');
        return $class;
    }
    private function replaceTemplateAnnotation(\PhpParser\Node\Stmt\ClassMethod $classMethod) : ?\PhpParser\Node
    {
        ...
        $doctrineAnnotationTagValueNode = $phpDocInfo->getByAnnotationClass('Typo3RectorPrefix20210409\\Sensio\\Bundle\\FrameworkExtraBundle\\Configuration\\Template');
    ...
    private function hasTemplateAnnotations(\PhpParser\Node\Stmt\Class_ $class) : bool
    {
        foreach ($class->getMethods() as $classMethod) {
            $phpDocInfo = $this->phpDocInfoFactory->createFromNodeOrEmpty($classMethod);
            if ($phpDocInfo->hasByAnnotationClass('Typo3RectorPrefix20210409\\Sensio\\Bundle\\FrameworkExtraBundle\\Configuration\\Template')) {
                return \true;
            }
        }
        return \false;
