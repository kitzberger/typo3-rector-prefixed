...
CODE_SAMPLE
    ...
    {
        if (!$this->classManipulator->hasInterface($node, 'Typo3RectorPrefix20210318\\Gedmo\\Translatable\\Translatable')) {
            return null;
        }
        $this->classManipulator->removeInterface($node, 'Typo3RectorPrefix20210318\\Gedmo\\Translatable\\Translatable');
        // 1. replace trait
        $this->classInsertManipulator->addAsFirstTrait($node, 'Typo3RectorPrefix20210318\\Knp\\DoctrineBehaviors\\Model\\Translatable\\TranslatableTrait');
        // 2. add interface
        $node->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210318\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TranslatableInterface');
