...
final class ComposerAutoloadedDirectoryProvider
{
     ...
     * @var string[]
     */
    private const AUTOLOAD_SECTIONS = [\Typo3RectorPrefix20210409\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \Typo3RectorPrefix20210409\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV];
    /**
     * @var string
     */
    ...
    public function __construct(\Typo3RectorPrefix20210409\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \Typo3RectorPrefix20210409\Nette\Utils\Json::decode($composerFileContent, \Typo3RectorPrefix20210409\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
