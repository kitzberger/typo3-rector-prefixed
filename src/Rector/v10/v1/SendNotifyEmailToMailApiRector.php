...
use Typo3RectorPrefix20210308\Symfony\Component\Mime\Address;
...
CODE_SAMPLE
    ...
    {
        return $this->nodeFactory->createMethodCall(self::MAIL, 'from', [new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified(\Typo3RectorPrefix20210308\Symfony\Component\Mime\Address::class), [$this->nodeFactory->createArg(new \PhpParser\Node\Expr\Variable(self::SENDER_ADDRESS)), $this->nodeFactory->createArg(new \PhpParser\Node\Expr\Variable('senderName'))])]);
    }
