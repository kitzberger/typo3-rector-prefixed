 ...
 */
class DecoratorServicePass extends \Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as [$id, $definition]) {
            ...
            $invalidBehavior = $decoratedService[3] ?? \Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $public = $definition->isPublic();
                $private = $definition->isPrivate();
            } else {
                throw new \Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($inner, $id);
            }
    ...
    {
        if ($value instanceof \Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\Reference && $this->innerId === (string) $value) {
            return new \Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }
