...
use Typo3RectorPrefix20210423\Symfony\Component\Config\Loader\GlobFileLoader;
...
use Typo3RectorPrefix20210423\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle;
use Typo3RectorPrefix20210423\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
use Typo3RectorPrefix20210423\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle;
use Typo3RectorPrefix20210423\Symplify\Skipper\Bundle\SkipperBundle;
 ...
 */
final class RectorKernel extends \Typo3RectorPrefix20210423\Symfony\Component\HttpKernel\Kernel
{
    /**
     * @var SmartFileInfo[]
     */
    ...
    {
        return [new \Typo3RectorPrefix20210423\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \Typo3RectorPrefix20210423\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle(), new \Typo3RectorPrefix20210423\Symplify\Skipper\Bundle\SkipperBundle(), new \Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle()];
    }
    protected function build(\Typo3RectorPrefix20210423\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        ...
        $containerBuilder->addCompilerPass(new \Typo3RectorPrefix20210423\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]));
     ...
     */
    protected function getContainerLoader(\Typo3RectorPrefix20210423\Symfony\Component\DependencyInjection\ContainerInterface $container) : \Typo3RectorPrefix20210423\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \Typo3RectorPrefix20210423\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \Typo3RectorPrefix20210423\Symfony\Component\Config\Loader\LoaderResolver([new \Typo3RectorPrefix20210423\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \Typo3RectorPrefix20210423\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
