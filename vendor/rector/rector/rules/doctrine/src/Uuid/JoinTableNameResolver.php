...
final class JoinTableNameResolver
{
    ...
    {
        if (!\Typo3RectorPrefix20210324\Nette\Utils\Strings::contains($currentClass, '\\')) {
            return $currentClass;
        }
        return (string) \Typo3RectorPrefix20210324\Nette\Utils\Strings::after($currentClass, '\\', -1);
    }
}
