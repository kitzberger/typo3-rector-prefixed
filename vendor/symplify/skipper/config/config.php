...
return static function (\Typo3RectorPrefix20210411\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('Typo3RectorPrefix20210411\Symplify\\Skipper\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/Bundle', __DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/ValueObject']);
    $services->set(\Typo3RectorPrefix20210411\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker::class);
    $services->set(\Typo3RectorPrefix20210411\Symplify\SmartFileSystem\Normalizer\PathNormalizer::class);
};
