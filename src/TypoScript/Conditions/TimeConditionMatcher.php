...
final class TimeConditionMatcher implements \Ssch\TYPO3Rector\TypoScript\Conditions\TyposcriptConditionMatcher
{
    ...
    public function change(string $condition) : ?string
    {
        ...
        $newConditions = [];
        $operatorsAndValues = \Ssch\TYPO3Rector\ArrayUtility::trimExplode(',', $value, \true);
    ...
    {
        return null !== \Typo3RectorPrefix20210411\Nette\Utils\Strings::match($condition, '#' . self::ALLOWED_TIME_CONSTANTS . '#Ui');
    }
}
