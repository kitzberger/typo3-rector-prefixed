 ...
 */
final class CloningPhpDocNodeVisitor extends \Typo3RectorPrefix20210422\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    public function enterNode(\PHPStan\PhpDocParser\Ast\Node $origNode) : ?\PHPStan\PhpDocParser\Ast\Node
    {
        $node = clone $origNode;
        $node->setAttribute(\Typo3RectorPrefix20210422\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::ORIG_NODE, $origNode);
        return $node;
    }
}
