...
use Typo3RectorPrefix20210316\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use Typo3RectorPrefix20210316\Doctrine\Persistence\Proxy;
use Typo3RectorPrefix20210316\Mockery\MockInterface;
use Typo3RectorPrefix20210316\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use Typo3RectorPrefix20210316\PHPUnit\Framework\MockObject\MockObject;
use Typo3RectorPrefix20210316\Prophecy\Prophecy\ProphecySubjectInterface;
use Typo3RectorPrefix20210316\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\Typo3RectorPrefix20210316\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\Typo3RectorPrefix20210316\Psr\Log\LogLevel::class);
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \Typo3RectorPrefix20210316\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \Typo3RectorPrefix20210316\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \Typo3RectorPrefix20210316\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \Typo3RectorPrefix20210316\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \Typo3RectorPrefix20210316\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \Typo3RectorPrefix20210316\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \Typo3RectorPrefix20210316\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
