 ...
 */
class ContainerControllerResolver extends \Typo3RectorPrefix20210223\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\Typo3RectorPrefix20210223\Psr\Container\ContainerInterface $container, \Typo3RectorPrefix20210223\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \Typo3RectorPrefix20210223\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
