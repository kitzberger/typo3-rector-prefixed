 ...
 */
abstract class AbstractSurrogate implements \Typo3RectorPrefix20210415\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \Typo3RectorPrefix20210415\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        $subRequest = \Typo3RectorPrefix20210415\Symfony\Component\HttpFoundation\Request::create($uri, \Typo3RectorPrefix20210415\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \Typo3RectorPrefix20210415\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\Typo3RectorPrefix20210415\Symfony\Component\HttpFoundation\Response $response)
    {
