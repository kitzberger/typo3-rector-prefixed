...
final class NonPhpFileClassRenamerTest extends \Typo3RectorPrefix20210409\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var array<string, class-string>
     */
    private const CLASS_RENAMES = [
        'Session' => 'Typo3RectorPrefix20210409\\Illuminate\\Support\\Facades\\Session',
        ...
        // Laravel
        'Form' => 'Typo3RectorPrefix20210409\\Collective\\Html\\FormFacade',
        'Html' => 'Typo3RectorPrefix20210409\\Collective\\Html\\HtmlFacade',
    ];
    /**
    ...
    public function test(\Typo3RectorPrefix20210409\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        ...
        $inputAndExpected = \Typo3RectorPrefix20210409\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToInputAndExpected($fixtureFileInfo);
