...
final class GetAttributeReturnTypeExtension implements \PHPStan\Type\DynamicMethodReturnTypeExtension
{
    ...
    private const ARGUMENT_KEY_TO_RETURN_TYPE = [
        \Rector\NodeTypeResolver\Node\AttributeKey::class . '::FILE_INFO' => \Typo3RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo::class,
    ...
    public function __construct(\Typo3RectorPrefix20210423\Symplify\Astral\NodeValue\NodeValueResolver $nodeValueResolver)
    {
