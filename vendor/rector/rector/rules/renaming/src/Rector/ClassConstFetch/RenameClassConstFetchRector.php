...
, $configuration)]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \Typo3RectorPrefix20210316\Webmozart\Assert\Assert::allIsInstanceOf($renameClassConstFetches, \Rector\Renaming\Contract\RenameClassConstFetchInterface::class);
