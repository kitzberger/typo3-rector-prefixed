...
use Typo3RectorPrefix20210423\Symplify\ComposerJsonManipulator\ComposerJsonFactory;
...
use Typo3RectorPrefix20210423\Symplify\SmartFileSystem\Finder\SmartFinder;
...
return static function (\Typo3RectorPrefix20210423\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Typo3RectorPrefix20210423\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    ...
    $services->set(\Typo3RectorPrefix20210423\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\Typo3RectorPrefix20210423\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\Typo3RectorPrefix20210423\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\Typo3RectorPrefix20210423\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\Typo3RectorPrefix20210423\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
