...
namespace Typo3RectorPrefix20210323\Symplify\EasyTesting\Command;
...
use Typo3RectorPrefix20210323\Symplify\EasyTesting\Finder\FixtureFinder;
use Typo3RectorPrefix20210323\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use Typo3RectorPrefix20210323\Symplify\EasyTesting\ValueObject\Option;
use Typo3RectorPrefix20210323\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
use Typo3RectorPrefix20210323\Symplify\PackageBuilder\Console\ShellCode;
final class ValidateFixtureSkipNamingCommand extends \Typo3RectorPrefix20210323\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\Typo3RectorPrefix20210323\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \Typo3RectorPrefix20210323\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\Typo3RectorPrefix20210323\Symplify\EasyTesting\ValueObject\Option::SOURCE, \Typo3RectorPrefix20210323\Symfony\Component\Console\Input\InputArgument::REQUIRED | \Typo3RectorPrefix20210323\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\Typo3RectorPrefix20210323\Symplify\EasyTesting\ValueObject\Option::SOURCE);
