 ...
 * @final
 */
class AddRequestFormatsListener implements \Typo3RectorPrefix20210326\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\Typo3RectorPrefix20210326\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
