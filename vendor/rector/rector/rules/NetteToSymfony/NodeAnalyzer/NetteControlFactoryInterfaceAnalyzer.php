...
final class NetteControlFactoryInterfaceAnalyzer
{
    ...
    public function isComponentFactoryInterface(\PhpParser\Node\Stmt\Interface_ $interface) : bool
    {
        foreach ($interface->getMethods() as $classMethod) {
            ...
            $controlOrForm = new \PHPStan\Type\UnionType([new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210409\\Nette\\Application\\UI\\Control'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210409\\Nette\\Application\\UI\\Form')]);
