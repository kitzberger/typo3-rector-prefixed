...
use Typo3RectorPrefix20210412\Swift_Attachment;
use Typo3RectorPrefix20210412\Swift_Image;
...
CODE_SAMPLE
    ...
    private function refactorAttachMethod(\PhpParser\Node\Expr\MethodCall $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($firstArgument, new \PHPStan\Type\ObjectType(\Typo3RectorPrefix20210412\Swift_Attachment::class))) {
            return null;
        }
    ...
    private function refactorEmbedMethod(\PhpParser\Node\Expr\MethodCall $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($firstArgument, new \PHPStan\Type\ObjectType(\Typo3RectorPrefix20210412\Swift_Image::class))) {
            return null;
        }
        if (!$this->isName($firstArgument->name, 'fromPath')) {
            return null;
