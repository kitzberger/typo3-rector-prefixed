 ...
 */
namespace Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpCache;
...
use Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpKernelInterface;
use Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpKernelInterface, \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, int $type = \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, bool $catch = \true)
    {
        ...
        if (\Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     */
    protected function pass(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $response = $this->pass($request, $catch);
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
     ...
     * @throws \Exception
     */
    protected function lookup(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        try {
     ...
     * @return Response A Response instance
     */
    protected function validate(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $entry, bool $catch = \false)
    {
     ...
     * @return Response A Response instance
     */
    protected function fetch(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $subRequest = clone $request;
        // send no head requests because we want content
        if ('HEAD' === $request->getMethod()) {
     ...
     * @return Response A Response instance
     */
    protected function forward(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false, \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $entry = null)
    {
        if ($this->surrogate) {
            $this->surrogate->addSurrogateCapability($request);
        }
        // always a "master" request (as the real master request can be in cache)
        $response = \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \Typo3RectorPrefix20210402\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $catch);
        /*
     ...
     */
    protected function isFreshEnough(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     * @throws \Exception
     */
    protected function store(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $response)
    {
        try {
     ...
     */
    private function restoreResponseBody(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    protected function processResponseBody(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, \Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\Typo3RectorPrefix20210402\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
