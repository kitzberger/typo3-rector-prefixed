...
, [self::TYPO3_VERSION_CONSTRAINT => '^10.4'])]);
    ...
    private function addExtensionKey(\Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function addDescription(\Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function addLicense(\Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function fixPackageName(\Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
