...
final class RectorError
{
     ...
     */
    private $rectorClass;
    public function __construct(\Typo3RectorPrefix20210410\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $message, ?int $line = null, ?string $rectorClass = null)
    {
