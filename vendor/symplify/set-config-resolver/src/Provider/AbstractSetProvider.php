...
namespace Typo3RectorPrefix20210317\Symplify\SetConfigResolver\Provider;
...
abstract class AbstractSetProvider implements \Typo3RectorPrefix20210317\Symplify\SetConfigResolver\Contract\SetProviderInterface
{
    /**
     * @return string[]
     */
    ...
    public function provideByName(string $desiredSetName) : ?\Typo3RectorPrefix20210317\Symplify\SetConfigResolver\ValueObject\Set
    {
        ...
        } catch (\Typo3RectorPrefix20210317\Symplify\SymplifyKernel\Exception\ShouldNotHappenException $shouldNotHappenException) {
        }
    ...
    {
        $setPath = \Typo3RectorPrefix20210317\Nette\Utils\Strings::after($setPath, \DIRECTORY_SEPARATOR, -2);
        if ($setPath === null) {
