...
final class RamseyUuidInterfaceGuard implements \Rector\Naming\Contract\Guard\ConflictingNameGuardInterface
{
    ...
    {
        return $this->nodeTypeResolver->isObjectType($renameValueObject->getProperty(), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210409\\Ramsey\\Uuid\\UuidInterface'));
    }
}
