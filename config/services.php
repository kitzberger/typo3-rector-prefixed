...
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\Parser;
...
return static function (\Typo3RectorPrefix20210330\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->alias(\Typo3RectorPrefix20210330\Symfony\Component\Console\Application::class, \Ssch\TYPO3Rector\Console\Application::class);
    $services->load('Ssch\\TYPO3Rector\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/Rector', __DIR__ . '/../src/Set', __DIR__ . '/../src/Bootstrap', __DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/Compiler', __DIR__ . '/../src/ValueObject', __DIR__ . '/../src/TypoScript/Conditions', __DIR__ . '/../src/TypoScript/Visitors']);
    ...
    $services->set(\Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\Traverser\Traverser::class);
    $services->set(\Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->alias(\Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Tokenizer\TokenizerInterface::class, \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->set(\Ssch\TYPO3Rector\TypoScript\Parser\Printer\PrettyPrinter::class);
    $services->alias(\Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface::class, \Ssch\TYPO3Rector\TypoScript\Parser\Printer\PrettyPrinter::class);
    $services->set(\Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\Parser::class);
