...
CODE_SAMPLE
    ...
    private function shouldSkip(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        if (!$this->nodeTypeResolver->isObjectTypes($methodCall->var, [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\League\\Event\\EventDispatcher'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\League\\Event\\Emitter')])) {
            return \true;
        }
