...
class SomeClass
{
    public function run()
    {
        return new \Typo3RectorPrefix20210401\AnotherClass();
    }
}
...
class AnotherClass
{
    ...
    {
        return \Typo3RectorPrefix20210401\StaticClass::staticMethod();
    }
}
\class_alias('Typo3RectorPrefix20210401\\AnotherClass', 'AnotherClass', \false);
CODE_SAMPLE
, <<<'CODE_SAMPLE'
class SomeClass
{
