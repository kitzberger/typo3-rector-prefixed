...
use Typo3RectorPrefix20210408\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
CODE_SAMPLE
, [self::USE_IMPORTS_TO_RESTORE => [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Typo3RectorPrefix20210408\\Doctrine\\ORM\\Mapping', 'ORM')]])]);
    }
    /**
     * @return string[]
     */
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        foreach ($this->useImportsToRestore as $useImportToRestore) {
            ...
            if (!\Typo3RectorPrefix20210408\Nette\Utils\Strings::match($this->print($class), $annotationToSeek)) {
                continue;
            }
    ...
    {
        $default = [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Typo3RectorPrefix20210408\\Doctrine\\ORM\\Mapping', 'ORM'), new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Typo3RectorPrefix20210408\\Symfony\\Component\\Validator\\Constraints', 'Assert'), new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Typo3RectorPrefix20210408\\JMS\\Serializer\\Annotation', 'Serializer')];
    ...
    {
        $useBuilder = new \Typo3RectorPrefix20210408\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder($completeImportForPartialAnnotation->getUse());
