...
final class FileInfoDeletionAnalyzer
{
    ...
    public function isClassLikeAndFileInfoMatch(\PhpParser\Node\Stmt\ClassLike $classLike) : bool
    {
        ...
        $smartFileInfo = $classLike->getAttribute(\Typo3RectorPrefix20210408\Symplify\SmartFileSystem\SmartFileInfo::class);
    ...
    {
        return \Typo3RectorPrefix20210408\Nette\Utils\Strings::replace($name, self::TESTING_PREFIX_REGEX, '');
    }
}
