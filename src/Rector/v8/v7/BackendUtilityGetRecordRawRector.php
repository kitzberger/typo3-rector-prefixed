...
CODE_SAMPLE
    ...
    {
        $queryBuilder = $this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall(\TYPO3\CMS\Core\Utility\GeneralUtility::class, 'makeInstance', [$this->nodeFactory->createClassConstReference(\TYPO3\CMS\Core\Database\ConnectionPool::class)]), 'getQueryBuilderForTable', [$this->nodeFactory->createArg($firstArgument->value)]);
