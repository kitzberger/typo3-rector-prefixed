...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\Typo3RectorPrefix20210423\Nette\Utils\Strings::endsWith($shortClassName, 'Type')) {
            $shortClassName = (string) \Typo3RectorPrefix20210423\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
        $stringy = new \Typo3RectorPrefix20210423\Stringy\Stringy($shortClassName);
