...
class Status
{
    ...
    public function __construct($envAllowXdebug, $debug)
    {
        ...
        \Typo3RectorPrefix20210414\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART);
    ...
    {
        $this->output($this->getLoadedMessage());
        \Typo3RectorPrefix20210414\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART, (string) \microtime(\true));
    }
