...
CODE_SAMPLE
    ...
    {
        if (!(bool) \Typo3RectorPrefix20210316\Nette\Utils\Strings::match($stringValue, self::JSON_STRING_REGEX)) {
            return \false;
        }
        try {
            return (bool) \Typo3RectorPrefix20210316\Nette\Utils\Json::decode($stringValue, \Typo3RectorPrefix20210316\Nette\Utils\Json::FORCE_ARRAY);
    ...
    {
        $stringValue = \Typo3RectorPrefix20210316\Nette\Utils\Strings::replace($stringValue, self::UNQUOTED_OBJECT_HASH_REGEX, '$1"$2"');
