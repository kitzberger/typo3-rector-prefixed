...
class InstalledVersions
{
    ...
    public static function satisfies(\Typo3RectorPrefix20210323\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Typo3RectorPrefix20210323\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\Typo3RectorPrefix20210323\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
