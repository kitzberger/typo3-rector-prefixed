...
CODE_SAMPLE
    ...
    {
        $methodBuilder = new \Typo3RectorPrefix20210316\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('getControllerConfiguration');
        $methodBuilder->makeProtected();
        $methodBuilder->addParams([(new \Typo3RectorPrefix20210316\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('extensionName'))->getNode(), (new \Typo3RectorPrefix20210316\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('pluginName'))->getNode()]);
