...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, 'Typo3RectorPrefix20210321\\Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller')) {
            return null;
        }
        ...
        $parameterName = \Typo3RectorPrefix20210321\Nette\Utils\Strings::replace($parameterName, '#\\.#', '_');
