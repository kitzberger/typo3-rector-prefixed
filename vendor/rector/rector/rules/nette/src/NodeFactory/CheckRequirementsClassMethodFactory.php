...
final class CheckRequirementsClassMethodFactory
{
    ...
    {
        $methodBuilder = new \Typo3RectorPrefix20210408\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder(self::CHECK_REQUIREMENTS_METHOD_NAME);
        $methodBuilder->makePublic();
        $paramBuilder = new \Typo3RectorPrefix20210408\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('element');
