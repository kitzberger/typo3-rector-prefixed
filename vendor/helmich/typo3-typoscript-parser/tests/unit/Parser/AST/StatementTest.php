...
class StatementTest extends \Typo3RectorPrefix20210418\PHPUnit\Framework\TestCase
{
    ...
    public function testInvalidSourceLineThrowsException($invalidSourceLine)
    {
        ...
        $statement = $this->getMockBuilder(\Typo3RectorPrefix20210418\Helmich\TypoScriptParser\Parser\AST\Statement::class)->setConstructorArgs([$invalidSourceLine])->enableOriginalConstructor()->getMockForAbstractClass();
    }
}
