...
namespace Typo3RectorPrefix20210302\Symplify\MarkdownDiff\Differ;
...
final class MarkdownDiffer
{
    ...
    public function __construct(\Typo3RectorPrefix20210302\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \Typo3RectorPrefix20210302\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \Typo3RectorPrefix20210302\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
