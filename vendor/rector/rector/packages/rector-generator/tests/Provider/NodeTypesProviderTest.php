...
final class NodeTypesProviderTest extends \Typo3RectorPrefix20210402\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function test() : void
    {
        ...
        $this->assertContains('Typo3RectorPrefix20210402\\Expr\\New_', $nodeTypes);
