...
final class NodeTypesProviderTest extends \Typo3RectorPrefix20210318\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function test() : void
    {
        ...
        $this->assertContains('Typo3RectorPrefix20210318\\Expr\\New_', $nodeTypes);
