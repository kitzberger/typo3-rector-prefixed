 ...
 */
class ResourceCheckerConfigCacheFactory implements \Typo3RectorPrefix20210410\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \Typo3RectorPrefix20210410\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;
