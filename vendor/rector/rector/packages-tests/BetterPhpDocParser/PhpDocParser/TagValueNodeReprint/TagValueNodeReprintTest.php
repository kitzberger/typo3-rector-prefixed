...
use Typo3RectorPrefix20210414\Symplify\EasyTesting\FixtureSplitter\TrioFixtureSplitter;
use Typo3RectorPrefix20210414\Symplify\EasyTesting\ValueObject\FixtureSplit\TrioContent;
...
final class TagValueNodeReprintTest extends \Typo3RectorPrefix20210414\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var FileInfoParser
     */
     ...
     */
    public function test(\Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $trioFixtureSplitter = new \Typo3RectorPrefix20210414\Symplify\EasyTesting\FixtureSplitter\TrioFixtureSplitter();
    ...
    {
        return \Typo3RectorPrefix20210414\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory(__DIR__ . '/Fixture');
    }
    /**
     * @return Iterator<SmartFileInfo>
     */
    ...
    {
        return \Typo3RectorPrefix20210414\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectory(__DIR__ . '/FixtureNested');
    }
    /**
     * @param class-string $annotationClass
     * @param class-string<Node> $nodeClass
     */
    private function doTestPrintedPhpDocInfo(\Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $annotationClass, string $nodeClass) : void
    {
    ...
    private function createFixtureFileInfo(\Typo3RectorPrefix20210414\Symplify\EasyTesting\ValueObject\FixtureSplit\TrioContent $trioContent, \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $fixturefileInfo) : \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo
    {
        ...
        return new \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo($temporaryFileName);
    }
    /**
     * @template T as Node
     ...
     * @return T
     */
    private function parseFileAndGetFirstNodeOfType(\Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $nodeType) : \PhpParser\Node
    {
     ...
     * @param class-string $annotationClass
     */
    private function doTestContainsTagValueNodeType(\PhpParser\Node $node, string $annotationClass, \Typo3RectorPrefix20210414\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $phpDocInfo = $this->phpDocInfoFactory->createFromNodeOrEmpty($node);
