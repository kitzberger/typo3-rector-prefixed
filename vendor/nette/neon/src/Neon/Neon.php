...
final class Neon
{
    public const BLOCK = \Typo3RectorPrefix20210331\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \Typo3RectorPrefix20210331\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \Typo3RectorPrefix20210331\Nette\Neon\Decoder();
