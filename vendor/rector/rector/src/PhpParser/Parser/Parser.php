...
final class Parser
{
    ...
    public function __construct(\PhpParser\Parser $nikicParser, \Typo3RectorPrefix20210329\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
     ...
     * @return Node[]
     */
    public function parseFileInfo(\Typo3RectorPrefix20210329\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
