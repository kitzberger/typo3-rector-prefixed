...
final class UpdateFileNameByClassNameFileSystemRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    public function test(\Typo3RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        ...
        $expectedAddedFileWithContent = new \Rector\FileSystemRector\ValueObject\AddedFileWithContent($this->originalTempFileInfo->getRealPathDirectory() . '/SkipDifferentClassName.php', \Typo3RectorPrefix20210423\Nette\Utils\FileSystem::read(__DIR__ . '/Fixture/skip_different_class_name.php.inc'));
