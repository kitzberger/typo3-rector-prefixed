...
namespace Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Tests\Functional\Parser;

use Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\ParseError;
...
class ParserTest extends \Typo3RectorPrefix20210423\PHPUnit\Framework\TestCase
{
    /** @var Parser */
    private $parser;
    public function setUp() : void
    {
        $this->parser = new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\Parser(new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Tokenizer\Tokenizer());
    }
    ...
    {
        $this->expectException(\Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\ParseError::class);
