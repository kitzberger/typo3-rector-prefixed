...
final class AllowedAutoloadedTypeAnalyzer
{
     ...
     */
    private const ALLOWED_CLASSES = [\DateTimeInterface::class, 'Typo3RectorPrefix20210414\\Symplify\\SmartFileSystem\\SmartFileInfo'];
    ...
    private function isAllowedClassString(string $value) : bool
    {
        ...
        if (\Typo3RectorPrefix20210414\Nette\Utils\Strings::match($value, self::AUTOLOADED_CLASS_PREFIX_REGEX)) {
            return \true;
        }
