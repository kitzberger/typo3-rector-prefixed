...
final class FilesystemTweaker
{
    ...
    public function __construct(\Typo3RectorPrefix20210317\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function resolveDirectoriesWithFnmatch(array $directories) : array
    {
        ...
        foreach ($directories as $directory) {
            ...
            if (\Typo3RectorPrefix20210317\Nette\Utils\Strings::contains($directory, '*')) {
