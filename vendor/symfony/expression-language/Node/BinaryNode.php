 ...
 * @internal
 */
class BinaryNode extends \Typo3RectorPrefix20210321\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['~' => '.', 'and' => '&&', 'or' => '||'];
    private const FUNCTIONS = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct(string $operator, \Typo3RectorPrefix20210321\Symfony\Component\ExpressionLanguage\Node\Node $left, \Typo3RectorPrefix20210321\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
