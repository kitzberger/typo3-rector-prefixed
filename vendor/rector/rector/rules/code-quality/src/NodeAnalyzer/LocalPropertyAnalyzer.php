...
final class LocalPropertyAnalyzer
{
     ...
     * @var string
     */
    private const LARAVEL_COLLECTION_CLASS = 'Typo3RectorPrefix20210315\\Illuminate\\Support\\Collection';
    /**
