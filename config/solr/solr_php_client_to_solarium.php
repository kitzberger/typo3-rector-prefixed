...
return static function (\Typo3RectorPrefix20210317\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set('apache_solr_to_solarium_classes')->class(\Rector\Renaming\Rector\Name\RenameClassRector::class)->call('configure', [[\Rector\Renaming\Rector\Name\RenameClassRector::OLD_TO_NEW_CLASSES => [\Typo3RectorPrefix20210317\Apache_Solr_Document::class => \ApacheSolrForTypo3\Solr\System\Solr\Document\Document::class, \Typo3RectorPrefix20210317\Apache_Solr_Response::class => \ApacheSolrForTypo3\Solr\System\Solr\ResponseAdapter::class]]]);
};
