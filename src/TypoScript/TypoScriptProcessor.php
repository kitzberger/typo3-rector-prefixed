...
final class TypoScriptProcessor implements \Ssch\TYPO3Rector\Processor\ConfigurableProcessorInterface
{
     ...
     */
    public function __construct(\Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\ParserInterface $typoscriptParser, \Typo3RectorPrefix20210415\Symfony\Component\Console\Output\BufferedOutput $output, \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface $typoscriptPrinter, array $visitors = [])
    {
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file) : void
    {
        try {
            ...
            $traverser = new \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\Traverser\Traverser($originalStatements);
        ...
        } catch (\Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Tokenizer\TokenizerException $tokenizerException) {
            return;
        }
    }
}
