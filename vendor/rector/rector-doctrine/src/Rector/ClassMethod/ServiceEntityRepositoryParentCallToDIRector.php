...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $entityManagerObjectType = new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210412\\Doctrine\\ORM\\EntityManagerInterface');
    ...
    private function shouldSkipClassMethod(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        return !$classReflection->isSubclassOf('Typo3RectorPrefix20210412\\Doctrine\\Bundle\\DoctrineBundle\\Repository\\ServiceEntityRepository');
    }
