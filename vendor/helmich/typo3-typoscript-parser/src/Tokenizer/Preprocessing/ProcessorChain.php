 ...
 */
class ProcessorChain implements \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Tokenizer\Preprocessing\Preprocessor
{
    /** @var Preprocessor[] */
     ...
     * @return self
     */
    public function with(\Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Tokenizer\Preprocessing\Preprocessor $next) : self
    {
        $new = new self();
