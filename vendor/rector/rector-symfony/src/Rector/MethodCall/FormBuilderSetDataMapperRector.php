...
final class FormBuilderSetDataMapperRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->dataMapperObjectType = new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210415\\Symfony\\Component\\Form\\Extension\\Core\\DataMapper\\DataMapper');
    }
...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node->var, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210415\\Symfony\\Component\\Form\\FormConfigBuilderInterface'))) {
            return null;
        }
        ...
        $propertyPathAccessor = new \PhpParser\Node\Expr\New_(new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210415\\Symfony\\Component\\Form\\Extension\\Core\\DataAccessor\\PropertyPathAccessor'));
