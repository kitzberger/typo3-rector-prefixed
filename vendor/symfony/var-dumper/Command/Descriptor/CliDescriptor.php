 ...
 * @final
 */
class CliDescriptor implements \Typo3RectorPrefix20210317\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\Typo3RectorPrefix20210317\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\Typo3RectorPrefix20210317\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \Typo3RectorPrefix20210317\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \Typo3RectorPrefix20210317\Symfony\Component\Console\Style\SymfonyStyle(new \Typo3RectorPrefix20210317\Symfony\Component\Console\Input\ArrayInput([]), $output);
