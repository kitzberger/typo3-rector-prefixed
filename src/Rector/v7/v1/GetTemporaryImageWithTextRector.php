...
final class GetTemporaryImageWithTextRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, new \PHPStan\Type\ObjectType(\TYPO3\CMS\Core\Resource\Processing\LocalImageProcessor::class))) {
            return null;
        }
