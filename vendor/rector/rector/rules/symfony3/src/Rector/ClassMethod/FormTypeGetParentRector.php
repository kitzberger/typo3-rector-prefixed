...
CODE_SAMPLE
    ...
    private function isClassAndMethodMatch(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        if ($this->isObjectType($classLike, 'Typo3RectorPrefix20210227\\Symfony\\Component\\Form\\AbstractType')) {
            return $this->isName($classMethod->name, 'getParent');
        }
        if ($this->isObjectType($classMethod, 'Typo3RectorPrefix20210227\\Symfony\\Component\\Form\\AbstractTypeExtension')) {
