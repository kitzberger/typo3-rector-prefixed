...
namespace Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\Tests\PhpDocNodeVisitor;
...
final class ParentConnectingPhpDocNodeVisitorTest extends \Typo3RectorPrefix20210423\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    protected function setUp() : void
    {
        ...
        $parentConnectingPhpDocNodeVisitor = $this->getService(\Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\ParentConnectingPhpDocNodeVisitor::class);
    ...
    public function testChildNode() : void
    {
        ...
        $childParent = $phpDocChildNode->getAttribute(\Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
    ...
    public function testTypeNode() : void
    {
        ...
        $returnParent = $returnTagValueNode->getAttribute(\Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
        $this->assertSame($phpDocChildNode, $returnParent);
        $returnTypeParent = $returnTagValueNode->type->getAttribute(\Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
