 ...
 * @internal
 */
class UnaryNode extends \Typo3RectorPrefix20210223\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \Typo3RectorPrefix20210223\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
