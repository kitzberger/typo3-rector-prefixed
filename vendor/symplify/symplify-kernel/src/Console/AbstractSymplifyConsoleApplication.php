...
abstract class AbstractSymplifyConsoleApplication extends \Typo3RectorPrefix20210421\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \Typo3RectorPrefix20210421\Symplify\PackageBuilder\Console\Command\CommandNaming();
