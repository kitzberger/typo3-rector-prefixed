...
, $configuration)]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \Typo3RectorPrefix20210330\Webmozart\Assert\Assert::allIsInstanceOf($callsWithParamNames, \Rector\CakePHP\ValueObject\RenameMethodCallBasedOnParameter::class);
