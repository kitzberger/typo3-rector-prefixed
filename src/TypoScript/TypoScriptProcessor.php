...
final class TypoScriptProcessor implements \Ssch\TYPO3Rector\Processor\ProcessorInterface, \Ssch\TYPO3Rector\Processor\ConfigurableProcessorInterface
{
     ...
     */
    public function __construct(\Typo3RectorPrefix20210405\Helmich\TypoScriptParser\Parser\ParserInterface $typoscriptParser, \Typo3RectorPrefix20210405\Symfony\Component\Console\Output\BufferedOutput $output, \Typo3RectorPrefix20210405\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface $typoscriptPrinter, \Rector\ChangesReporting\Application\ErrorAndDiffCollector $errorAndDiffCollector, array $visitors = [])
    {
    ...
    public function process(\Typo3RectorPrefix20210405\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : ?string
    {
        try {
            ...
            $traverser = new \Typo3RectorPrefix20210405\Helmich\TypoScriptParser\Parser\Traverser\Traverser($originalStatements);
        ...
        } catch (\Typo3RectorPrefix20210405\Helmich\TypoScriptParser\Tokenizer\TokenizerException $tokenizerException) {
            return null;
        }
    }
