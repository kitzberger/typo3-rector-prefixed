...
final class EntityAliasToClassConstantReferenceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    {
        $this->doctrineManagerRegistryObjectTypes = [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\Doctrine\\ORM\\EntityManagerInterface'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\Doctrine\\Persistence\\ObjectManager'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\Doctrine\\Common\\Persistence\\ObjectManager'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\Doctrine\\Persistence\\ManagerRegistry'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\Doctrine\\Common\\Persistence\\ManagerRegistry')];
    }
...
CODE_SAMPLE
, [self::ALIASES_TO_NAMESPACES => ['App' => 'Typo3RectorPrefix20210413\\App\\Entity']])]);
    }
    /**
    ...
    {
        return \Typo3RectorPrefix20210413\Nette\Utils\Strings::contains($name, ':');
    }
