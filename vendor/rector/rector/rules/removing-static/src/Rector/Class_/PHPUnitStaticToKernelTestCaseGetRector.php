...
final class SomeTestCase extends \Typo3RectorPrefix20210311\PHPUnit\Framework\TestCase
{
    public function test()
    {
        $product = \Typo3RectorPrefix20210311\EntityFactory::create('product');
    }
}
\class_alias('Typo3RectorPrefix20210311\\SomeTestCase', 'SomeTestCase', \false);
CODE_SAMPLE
, <<<'CODE_SAMPLE'
...
, [self::STATIC_CLASS_TYPES => ['EntityFactory']])]);
    ...
    private function processPHPUnitClass(\PhpParser\Node\Stmt\Class_ $class) : ?\PhpParser\Node\Stmt\Class_
    {
        ...
        if (!$this->isObjectType($class, 'Typo3RectorPrefix20210311\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase')) {
            $class->extends = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210311\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase');
        }
        return $class;
    }
    /**
