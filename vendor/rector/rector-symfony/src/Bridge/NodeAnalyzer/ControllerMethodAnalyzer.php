...
final class ControllerMethodAnalyzer
{
    ...
    public function isAction(\PhpParser\Node $node) : bool
    {
        ...
        if (\Typo3RectorPrefix20210412\Nette\Utils\Strings::endsWith($parentClassName, 'Controller')) {
            return \true;
        }
        if (\Typo3RectorPrefix20210412\Nette\Utils\Strings::endsWith((string) $node->name, 'Action')) {
            return \true;
        }
