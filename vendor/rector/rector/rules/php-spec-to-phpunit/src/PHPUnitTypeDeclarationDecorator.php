...
final class PHPUnitTypeDeclarationDecorator
{
    ...
    {
        if (!\class_exists('Typo3RectorPrefix20210405\\PHPUnit\\Framework\\TestCase')) {
            return;
        }
        // skip test run
        ...
        $reflectionMethod = new \ReflectionMethod('Typo3RectorPrefix20210405\\PHPUnit\\Framework\\TestCase', \Rector\Core\ValueObject\MethodName::SET_UP);
