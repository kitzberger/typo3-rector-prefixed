...
class TokenizerExceptionTest extends \Typo3RectorPrefix20210413\PHPUnit\Framework\TestCase
{
    public function testCanGetSourceLine()
    {
        $exc = new \Typo3RectorPrefix20210413\Helmich\TypoScriptParser\Tokenizer\TokenizerException('Foobar', 1234, null, 4312);
