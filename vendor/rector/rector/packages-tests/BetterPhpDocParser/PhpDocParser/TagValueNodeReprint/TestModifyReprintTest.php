...
final class TestModifyReprintTest extends \Typo3RectorPrefix20210415\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var FileInfoParser
     */
    ...
    {
        $fixtureFileInfo = new \Typo3RectorPrefix20210415\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/FixtureModify/route_with_extra_methods.php.inc');
        $inputFileInfoAndExpected = \Typo3RectorPrefix20210415\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($fixtureFileInfo);
        ...
        $doctrineAnnotationTagValueNode = $phpDocInfo->getByAnnotationClass('Typo3RectorPrefix20210415\\Symfony\\Component\\Routing\\Annotation\\Route');
     ...
     */
    private function parseFileAndGetFirstNodeOfType(\Typo3RectorPrefix20210415\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, string $nodeType) : \Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfo
    {
