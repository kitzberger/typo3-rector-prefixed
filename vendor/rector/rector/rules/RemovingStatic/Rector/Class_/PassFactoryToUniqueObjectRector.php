...
class SomeClass
{
    public function run()
    {
        return new \Typo3RectorPrefix20210413\AnotherClass();
    }
}
\class_alias('Typo3RectorPrefix20210413\\SomeClass', 'SomeClass', \false);
class AnotherClass
{
    public function someFun()
    {
        return \Typo3RectorPrefix20210413\StaticClass::staticMethod();
    }
}
\class_alias('Typo3RectorPrefix20210413\\AnotherClass', 'AnotherClass', \false);
CODE_SAMPLE
, <<<'CODE_SAMPLE'
class SomeClass
{
