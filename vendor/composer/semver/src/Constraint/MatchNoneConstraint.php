 ...
 */
class MatchNoneConstraint implements \Typo3RectorPrefix20210316\Composer\Semver\Constraint\ConstraintInterface
{
    /** @var string|null */
    ...
    {
        return new \Typo3RectorPrefix20210316\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \false);
    }
    /**
     * {@inheritDoc}
     */
