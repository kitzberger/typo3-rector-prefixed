...
final class GlobalVarConditionMatcher implements \Ssch\TYPO3Rector\TypoScript\Conditions\TyposcriptConditionMatcher
{
    ...
    {
        return \Typo3RectorPrefix20210411\Nette\Utils\Strings::startsWith($condition, self::TYPE);
    }
    ...
    {
        if (\Typo3RectorPrefix20210411\Nette\Utils\Strings::startsWith($property, 'page')) {
