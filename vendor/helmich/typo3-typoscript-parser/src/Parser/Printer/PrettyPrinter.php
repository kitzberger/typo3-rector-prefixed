...
namespace Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\Printer;

use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Comment;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\ConditionalStatement;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\DirectoryIncludeStatement;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\FileIncludeStatement;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\IncludeStatement;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\MultilineComment;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\NestedAssignment;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\BinaryObjectOperator;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Copy;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Delete;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Modification;
use Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Reference;
 ...
 */
class PrettyPrinter implements \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface
{
    /**
     ...
     * @return void
     */
    private function printStatementList(array $statements, \Typo3RectorPrefix20210330\Symfony\Component\Console\Output\OutputInterface $output, int $nesting = 0) : void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            } elseif ($statement instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment) {
                $this->printAssignment($output, $statement, $indent);
            } elseif ($statement instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\BinaryObjectOperator) {
                $this->printBinaryObjectOperator($output, $statement, $nesting);
            } elseif ($statement instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Delete) {
            ...
            } elseif ($statement instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\MultilineComment) {
                $output->writeln($indent . $statement->comment);
            }
        }
    }
    ...
    private function printBinaryObjectOperator(\Typo3RectorPrefix20210330\Symfony\Component\Console\Output\OutputInterface $output, \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\BinaryObjectOperator $operator, int $nesting) : void
    {
        $targetObjectPath = $operator->target->relativeName;
        if ($operator instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Copy) {
            $output->writeln($this->getIndent($nesting) . $operator->object->relativeName . ' < ' . $targetObjectPath);
        } elseif ($operator instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Reference) {
            $output->writeln($this->getIndent($nesting) . $operator->object->relativeName . ' =< ' . $targetObjectPath);
        }
    }
    private function printIncludeStatement(\Typo3RectorPrefix20210330\Symfony\Component\Console\Output\OutputInterface $output, \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\IncludeStatement $statement) : void
    {
        if ($statement instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\FileIncludeStatement) {
            $this->printFileIncludeStatement($output, $statement);
        } elseif ($statement instanceof \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\DirectoryIncludeStatement) {
    ...
    private function printDirectoryIncludeStatement(\Typo3RectorPrefix20210330\Symfony\Component\Console\Output\OutputInterface $output, \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\DirectoryIncludeStatement $statement) : void
    {
        $attributes = "";
     ...
     */
    private function printNestedAssignment(\Typo3RectorPrefix20210330\Symfony\Component\Console\Output\OutputInterface $output, $nesting, \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\NestedAssignment $statement) : void
    {
     ...
     * @param string          $indent
     */
    private function printAssignment(\Typo3RectorPrefix20210330\Symfony\Component\Console\Output\OutputInterface $output, \Typo3RectorPrefix20210330\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement, string $indent) : void
    {
