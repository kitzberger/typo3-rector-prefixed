...
if (\interface_exists(\Typo3RectorPrefix20210323\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \Typo3RectorPrefix20210323\Psr\Cache\CacheException, \Typo3RectorPrefix20210323\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \Typo3RectorPrefix20210323\Psr\Cache\CacheException
    {
    }
}
