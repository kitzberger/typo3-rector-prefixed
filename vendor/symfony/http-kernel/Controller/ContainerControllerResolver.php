 ...
 */
class ContainerControllerResolver extends \Typo3RectorPrefix20210415\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    ...
    {
        if ($this->container instanceof \Typo3RectorPrefix20210415\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
