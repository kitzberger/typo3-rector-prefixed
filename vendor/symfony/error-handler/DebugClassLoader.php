...
use Typo3RectorPrefix20210421\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use Typo3RectorPrefix20210421\Doctrine\Persistence\Proxy;
use Typo3RectorPrefix20210421\Mockery\MockInterface;
use Typo3RectorPrefix20210421\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use Typo3RectorPrefix20210421\PHPUnit\Framework\MockObject\MockObject;
use Typo3RectorPrefix20210421\Prophecy\Prophecy\ProphecySubjectInterface;
use Typo3RectorPrefix20210421\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\Typo3RectorPrefix20210421\Symfony\Component\ErrorHandler\ErrorHandler::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \Typo3RectorPrefix20210421\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
