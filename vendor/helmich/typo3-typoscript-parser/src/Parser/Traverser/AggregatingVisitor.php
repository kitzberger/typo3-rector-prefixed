...
namespace Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\Traverser;
 ...
 */
class AggregatingVisitor implements \Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\Traverser\Visitor
{
    /** @var Visitor[] */
    private $visitors = [];
    /**
     ...
     * @return void
     */
    public function addVisitor(\Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : void
    {
     ...
     * @return void
     */
    public function exitNode(\Typo3RectorPrefix20210415\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        foreach ($this->visitors as $visitor) {
