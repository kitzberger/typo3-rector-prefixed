...
namespace Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Tests\Unit\Parser\Traverser;
...
class TraverserTest extends \Typo3RectorPrefix20210423\PHPUnit\Framework\TestCase
{
    private $tree;
    /** @var Traverser */
    private $traverser;
    ...
    {
        $this->tree = [new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment(new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\ObjectPath('foo', 'foo'), new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Scalar('bar'), 1), new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\ConditionalStatement('[globalVar = GP:foo=1]', [new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment(new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\ObjectPath('foo', 'foo'), new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Scalar('bar'), 2)], [new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment(new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\ObjectPath('foo', 'foo'), new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Scalar('baz'), 4)], 2), new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\NestedAssignment(new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\ObjectPath('bar', 'bar'), [new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment(new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\ObjectPath('bar.baz', 'baz'), new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Scalar('foo'), 1)], 3)];
        $this->traverser = new \Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\Traverser\Traverser($this->tree);
    }
    public function testHookFunctionsAreCalled()
    {
        $visitor = $this->prophesize(\Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\Traverser\Visitor::class);
