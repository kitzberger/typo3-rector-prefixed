...
use Typo3RectorPrefix20210308\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer;
...
return static function (\Typo3RectorPrefix20210308\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\Typo3RectorPrefix20210308\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer::class)->call('configure', [['syntax' => 'short']]);
};
