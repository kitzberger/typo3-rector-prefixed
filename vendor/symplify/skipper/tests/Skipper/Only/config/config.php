...
return static function (\Typo3RectorPrefix20210223\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $parameters->set(\Typo3RectorPrefix20210223\Symplify\Skipper\ValueObject\Option::ONLY, [
        \Typo3RectorPrefix20210223\Symplify\Skipper\Tests\Skipper\Only\Source\IncludeThisClass::class => ['SomeFileToOnlyInclude.php'],
        // these 2 lines should be identical
        \Typo3RectorPrefix20210223\Symplify\Skipper\Tests\Skipper\Only\Source\SkipCompletely::class => null,
        \Typo3RectorPrefix20210223\Symplify\Skipper\Tests\Skipper\Only\Source\SkipCompletelyToo::class,
    ]);
};
