 ...
 * SQLite storage.
 */
class SQLiteStorage implements \Typo3RectorPrefix20210414\Nette\Caching\Storage, \Typo3RectorPrefix20210414\Nette\Caching\BulkReader
{
    ...
    {
        $expire = isset($dependencies[\Typo3RectorPrefix20210414\Nette\Caching\Cache::EXPIRATION]) ? $dependencies[\Typo3RectorPrefix20210414\Nette\Caching\Cache::EXPIRATION] + \time() : null;
        $slide = isset($dependencies[\Typo3RectorPrefix20210414\Nette\Caching\Cache::SLIDING]) ? $dependencies[\Typo3RectorPrefix20210414\Nette\Caching\Cache::EXPIRATION] : null;
    ...
    public function clean(array $conditions) : void
    {
        if (!empty($conditions[\Typo3RectorPrefix20210414\Nette\Caching\Cache::ALL])) {
            ...
            if (!empty($conditions[\Typo3RectorPrefix20210414\Nette\Caching\Cache::TAGS])) {
                $tags = $conditions[\Typo3RectorPrefix20210414\Nette\Caching\Cache::TAGS];
