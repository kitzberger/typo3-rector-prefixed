...
namespace Typo3RectorPrefix20210415\Symplify\SetConfigResolver\Config;
...
use Typo3RectorPrefix20210415\Symplify\Astral\Exception\ShouldNotHappenException;
use Typo3RectorPrefix20210415\Symplify\SetConfigResolver\SetResolver;
...
final class SetsParameterResolver
{
     ...
     */
    private $setResolver;
    public function __construct(\Typo3RectorPrefix20210415\Symplify\SetConfigResolver\SetResolver $setResolver)
    {
     ...
     * @return string[]
     */
    private function resolveSetsFromFileInfo(\Typo3RectorPrefix20210415\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        if ($configFileInfo->hasSuffixes(['yml', 'yaml'])) {
            throw new \Typo3RectorPrefix20210415\Symplify\Astral\Exception\ShouldNotHappenException('Only PHP config suffix is supported now. Migrete your Symfony config to PHP');
        }
     ...
     * @return string[]
     */
    private function resolveSetsParameterFromPhpFileInfo(\Typo3RectorPrefix20210415\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        // php file loader
