...
class StatementTest extends \Typo3RectorPrefix20210423\PHPUnit\Framework\TestCase
{
    ...
    public function testInvalidSourceLineThrowsException($invalidSourceLine)
    {
        ...
        $statement = $this->getMockBuilder(\Typo3RectorPrefix20210423\Helmich\TypoScriptParser\Parser\AST\Statement::class)->setConstructorArgs([$invalidSourceLine])->enableOriginalConstructor()->getMockForAbstractClass();
    }
}
