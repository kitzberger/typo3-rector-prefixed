...
final class TranslationClassNodeFactory
{
    ...
    public function create(string $classShortName) : \PhpParser\Node\Stmt\Class_
    {
        ...
        $class->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210326\\Knp\\DoctrineBehaviors\\Contract\\Entity\\TranslationInterface');
        $this->classInsertManipulator->addAsFirstTrait($class, 'Typo3RectorPrefix20210326\\Knp\\DoctrineBehaviors\\Model\\Translatable\\TranslationTrait');
