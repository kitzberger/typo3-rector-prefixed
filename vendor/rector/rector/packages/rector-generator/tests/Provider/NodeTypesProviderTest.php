...
final class NodeTypesProviderTest extends \Typo3RectorPrefix20210401\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function test() : void
    {
        ...
        $this->assertContains('Typo3RectorPrefix20210401\\Expr\\New_', $nodeTypes);
