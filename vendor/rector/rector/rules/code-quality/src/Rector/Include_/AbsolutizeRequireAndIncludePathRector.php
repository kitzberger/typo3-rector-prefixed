...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        // skip phar
        if (\Typo3RectorPrefix20210311\Nette\Utils\Strings::startsWith($includeValue, 'phar://')) {
            return null;
        }
        // add preslash to string
        // keep dots
        if (!\Typo3RectorPrefix20210311\Nette\Utils\Strings::startsWith($includeValue, '/') && !\Typo3RectorPrefix20210311\Nette\Utils\Strings::startsWith($includeValue, '.')) {
