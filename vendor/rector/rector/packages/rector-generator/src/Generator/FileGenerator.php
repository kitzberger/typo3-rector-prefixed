...
final class FileGenerator
{
    ...
    public function __construct(\Typo3RectorPrefix20210318\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\RectorGenerator\TemplateFactory $templateFactory, \Rector\RectorGenerator\FileSystem\TemplateFileSystem $templateFileSystem)
    {
     ...
     */
    private function generateFileInfoWithTemplateVariables(\Typo3RectorPrefix20210318\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $templateVariables, \Rector\RectorGenerator\ValueObject\RectorRecipe $rectorRecipe, string $targetDirectory) : string
    {
        ...
        if (!$rectorRecipe->isRectorRepository()) {
            $content = \Typo3RectorPrefix20210318\Nette\Utils\Strings::replace($content, self::RECTOR_UTILS_REGEX, 'Typo3RectorPrefix20210318\\Utils\\Rector');
        }
