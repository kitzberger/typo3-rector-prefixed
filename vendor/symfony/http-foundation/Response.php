...
class Response
{
    ...
    {
        $this->headers = new \Typo3RectorPrefix20210326\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\Typo3RectorPrefix20210326\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\Typo3RectorPrefix20210326\Symfony\Component\HttpFoundation\Request $request) : void
    {
