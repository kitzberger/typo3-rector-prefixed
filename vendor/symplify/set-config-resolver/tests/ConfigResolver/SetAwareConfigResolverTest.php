...
namespace Typo3RectorPrefix20210423\Symplify\SetConfigResolver\Tests\ConfigResolver;
...
use Typo3RectorPrefix20210423\Symplify\SetConfigResolver\Exception\SetNotFoundException;
use Typo3RectorPrefix20210423\Symplify\SetConfigResolver\SetAwareConfigResolver;
use Typo3RectorPrefix20210423\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider;
...
final class SetAwareConfigResolverTest extends \Typo3RectorPrefix20210423\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->setAwareConfigResolver = new \Typo3RectorPrefix20210423\Symplify\SetConfigResolver\SetAwareConfigResolver(new \Typo3RectorPrefix20210423\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider());
    }
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \Typo3RectorPrefix20210423\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    {
        $this->expectException(\Typo3RectorPrefix20210423\Symplify\SetConfigResolver\Exception\SetNotFoundException::class);
        $basicConfigFileInfo = new \Typo3RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/missing_set_config.php');
    ...
    {
        $basicConfigFileInfo = new \Typo3RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Fixture/php_config_with_sets.php');
        ...
        $expectedSetFileInfo = new \Typo3RectorPrefix20210423\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/some_php_set.php');
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \Typo3RectorPrefix20210423\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
