...
namespace Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser;

use PHPStan\PhpDocParser\Ast\Node;
use Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\Contract\PhpDocNodeVisitorInterface;
use Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\CallablePhpDocNodeVisitor;
/**
 * Mimics
...
final class PhpDocNodeTraverser
{
    ...
    public function addPhpDocNodeVisitor(\Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\Contract\PhpDocNodeVisitorInterface $phpDocNodeVisitor) : void
    {
    ...
    {
        $callablePhpDocNodeVisitor = new \Typo3RectorPrefix20210423\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\CallablePhpDocNodeVisitor($callable, $docContent);
