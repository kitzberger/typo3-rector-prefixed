...
// USE ↓
$fileRenamer = new \Typo3RectorPrefix20210331\FileRenamer();
$fileRenamer->rename(
    // paths
    [__DIR__ . '/../utils'],
    '*.php.inc',
...
final class FileRenamer
{
    ...
    {
        $this->smartFinder = new \Typo3RectorPrefix20210331\Symplify\SmartFileSystem\Finder\SmartFinder(new \Typo3RectorPrefix20210331\Symplify\SmartFileSystem\Finder\FinderSanitizer(), new \Typo3RectorPrefix20210331\Symplify\SmartFileSystem\FileSystemFilter());
    ...
    {
        \Typo3RectorPrefix20210331\Webmozart\Assert\Assert::allString($sources);
        \Typo3RectorPrefix20210331\Webmozart\Assert\Assert::allFileExists($sources);
    ...
    private function renameFileInfos(array $fileInfos, string $matchingRegex, string $replacement) : void
    {
        foreach ($fileInfos as $fileInfo) {
            ...
            $newRealPath = \Typo3RectorPrefix20210331\Nette\Utils\Strings::replace($oldRealPath, $matchingRegex, $replacement);
...
// CODE ↓
\class_alias('Typo3RectorPrefix20210331\\FileRenamer', 'FileRenamer', \false);
