...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isObjectType($node, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\Tester\\TestCase'))) {
            return null;
        }
    ...
    {
        if (!$this->isObjectType($methodCall->var, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210413\\Tester\\TestCase'))) {
            return;
        }
