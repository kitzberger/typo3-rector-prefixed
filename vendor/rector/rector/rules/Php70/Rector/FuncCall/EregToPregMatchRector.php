...
final class EregToPregMatchRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!\Typo3RectorPrefix20210423\Nette\Utils\Strings::startsWith($functionName, 'split')) {
            return;
        }
    ...
    {
        if (\Typo3RectorPrefix20210423\Nette\Utils\Strings::contains($functionName, 'eregi')) {
            return \true;
        }
        return \Typo3RectorPrefix20210423\Nette\Utils\Strings::contains($functionName, 'spliti');
    }
}
