 ...
 */
class ContainerControllerResolver extends \Typo3RectorPrefix20210329\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\Typo3RectorPrefix20210329\Psr\Container\ContainerInterface $container, \Typo3RectorPrefix20210329\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \Typo3RectorPrefix20210329\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
