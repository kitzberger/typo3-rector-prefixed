...
use Typo3RectorPrefix20210316\Symplify\SmartFileSystem\Json\JsonFileSystem;
final class ComposerPackageAutoloadUpdater
{
    ...
    public function __construct(\Typo3RectorPrefix20210316\Symplify\SmartFileSystem\Json\JsonFileSystem $jsonFileSystem, \Typo3RectorPrefix20210316\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    public function processComposerAutoload(\Rector\RectorGenerator\ValueObject\RectorRecipe $rectorRecipe) : void
    {
        ...
        $srcAutoload = $rectorRecipe->isRectorRepository() ? \Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD : \Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV;
        $composerJson[$srcAutoload][self::PSR_4][$package->getSrcNamespace()] = $package->getSrcDirectory();
        $composerJson[\Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV][self::PSR_4][$package->getTestsNamespace()] = $package->getTestsDirectory();
    ...
    {
        foreach ([\Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \Typo3RectorPrefix20210316\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV] as $autoloadSection) {
