...
final class ActiveRectorsProvider
{
     ...
     */
    public function __construct(array $rectors, \Typo3RectorPrefix20210324\Symplify\Skipper\Skipper\Skipper $skipper)
    {
        $dummyFileInfo = new \Typo3RectorPrefix20210324\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/../../config/config.php');
