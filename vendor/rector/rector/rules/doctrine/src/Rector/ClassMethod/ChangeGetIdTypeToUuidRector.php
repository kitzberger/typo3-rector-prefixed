...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $node->returnType = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210311\\Ramsey\\Uuid\\UuidInterface');
        return $node;
    }
    private function hasUuidReturnType(\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        ...
        return $this->isName($classMethod->returnType, \Typo3RectorPrefix20210311\Ramsey\Uuid\UuidInterface::class);
    }
}
