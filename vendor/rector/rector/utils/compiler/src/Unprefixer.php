...
final class Unprefixer
{
    ...
    {
        $match = \sprintf('\'%s\\\\r\\\\n\'', $prefix);
        $content = \Typo3RectorPrefix20210411\Nette\Utils\Strings::replace($content, '#' . $match . '#', '\'\\\\r\\\\n\'');
    ...
    {
        return \Typo3RectorPrefix20210411\Nette\Utils\Strings::replace($content, self::QUOTED_VALUE_REGEX, "'\$1");
    }
}
