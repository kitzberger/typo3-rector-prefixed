...
final class MoveServicesBySuffixToDirectoryRectorTest extends \Rector\Testing\PHPUnit\AbstractRectorTestCase
{
    ...
    public function provideData() : \Iterator
    {
        ...
        (yield [new \Typo3RectorPrefix20210413\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/Entity/UserMapper.php'), new \Rector\FileSystemRector\ValueObject\AddedFileWithContent($this->getFixtureTempDirectory() . '/Mapper/UserMapper.php', $smartFileSystem->readFile(__DIR__ . '/Expected/Mapper/UserMapper.php.inc'))]);
    }
    /**
     * @dataProvider provideDataSkipped()
     */
    public function testSkipped(\Typo3RectorPrefix20210413\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo) : void
    {
        $this->doTestFileInfo($originalFileInfo);
    ...
    {
        // nothing changes
        (yield [new \Typo3RectorPrefix20210413\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/Mapper/SkipCorrectMapper.php'), null]);
    }
