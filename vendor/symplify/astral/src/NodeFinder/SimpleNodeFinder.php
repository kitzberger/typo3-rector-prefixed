...
namespace Typo3RectorPrefix20210420\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use PhpParser\NodeFinder;
use Typo3RectorPrefix20210420\Symplify\Astral\ValueObject\CommonAttributeKey;
...
final class SimpleNodeFinder
{
     ...
     */
    private $nodeFinder;
    public function __construct(\Typo3RectorPrefix20210420\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \PhpParser\NodeFinder $nodeFinder)
    {
    ...
    {
        $node = $node->getAttribute(\Typo3RectorPrefix20210420\Symplify\Astral\ValueObject\CommonAttributeKey::PARENT);
        while ($node) {
