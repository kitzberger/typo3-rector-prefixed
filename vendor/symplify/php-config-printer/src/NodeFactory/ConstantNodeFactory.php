...
final class ConstantNodeFactory
{
    ...
    public function __construct(\Typo3RectorPrefix20210315\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider)
    {
    ...
    {
        if (\Typo3RectorPrefix20210315\Nette\Utils\Strings::contains($value, '::')) {
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\Typo3RectorPrefix20210315\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
