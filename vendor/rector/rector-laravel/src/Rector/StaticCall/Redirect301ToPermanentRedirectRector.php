...
final class Redirect301ToPermanentRedirectRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        $this->routerObjectTypes = [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210415\\Illuminate\\Support\\Facades\\Route'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210415\\Illuminate\\Routing\\Route')];
    }
