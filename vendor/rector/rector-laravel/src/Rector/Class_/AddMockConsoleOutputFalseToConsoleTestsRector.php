...
CODE_SAMPLE
    ...
    {
        if (!$this->isObjectType($node, new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210418\\Illuminate\\Foundation\\Testing\\TestCase'))) {
            return null;
        }
    ...
    private function isTestingConsoleOutput(\PhpParser\Node\Stmt\Class_ $class) : bool
    {
        return (bool) $this->betterNodeFinder->findFirst($class->stmts, function (\PhpParser\Node $node) : bool {
            ...
            if (!$callerType->isSuperTypeOf(new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210418\\Illuminate\\Support\\Facades\\Artisan'))->yes()) {
                return \false;
            }
