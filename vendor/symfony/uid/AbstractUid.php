...
abstract class AbstractUid implements \JsonSerializable
{
    ...
    {
        return \strtr(\sprintf('%022s', \Typo3RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::toBase($this->toBinary(), \Typo3RectorPrefix20210412\Symfony\Component\Uid\BinaryUtil::BASE58)), '0', '1');
    }
    /**
