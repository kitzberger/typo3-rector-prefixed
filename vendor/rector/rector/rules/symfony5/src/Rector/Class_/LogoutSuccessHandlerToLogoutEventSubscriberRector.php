...
final class LogoutSuccessHandlerToLogoutEventSubscriberRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const LOGOUT_SUCCESS_HANDLER_TYPE = 'Typo3RectorPrefix20210316\\Symfony\\Component\\Security\\Http\\Logout\\LogoutSuccessHandlerInterface';
    /**
...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $classConstFetch = $this->nodeFactory->createClassConstReference('Typo3RectorPrefix20210316\\Symfony\\Component\\Security\\Http\\Event\\LogoutEvent');
    ...
    {
        $class->implements[] = new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210316\\Symfony\\Component\\EventDispatcher\\EventSubscriberInterface');
