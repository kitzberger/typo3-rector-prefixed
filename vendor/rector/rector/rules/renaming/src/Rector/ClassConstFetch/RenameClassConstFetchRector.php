...
, $configuration)]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \Typo3RectorPrefix20210315\Webmozart\Assert\Assert::allIsInstanceOf($renameClassConstFetches, \Rector\Renaming\Contract\RenameClassConstFetchInterface::class);
