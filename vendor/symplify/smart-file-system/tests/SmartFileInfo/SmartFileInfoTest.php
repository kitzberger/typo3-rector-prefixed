...
namespace Typo3RectorPrefix20210316\Symplify\SmartFileSystem\Tests\SmartFileInfo;
...
final class SmartFileInfoTest extends \Typo3RectorPrefix20210316\PHPUnit\Framework\TestCase
{
    public function testInvalidPath() : void
    {
        $this->expectException(\Typo3RectorPrefix20210316\Symplify\SmartFileSystem\Exception\FileNotFoundException::class);
        new \Typo3RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileInfo('random');
    }
    public function testRelatives() : void
    {
        $smartFileInfo = new \Typo3RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
    ...
    {
        $smartFileInfo = new \Typo3RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/AnotherFile.txt');
    ...
    {
        $this->expectException(\Typo3RectorPrefix20210316\Symplify\SmartFileSystem\Exception\DirectoryNotFoundException::class);
        $smartFileInfo = new \Typo3RectorPrefix20210316\Symplify\SmartFileSystem\SmartFileInfo(__FILE__);
