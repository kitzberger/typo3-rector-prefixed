...
final class DispatchStringToObjectRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('Typo3RectorPrefix20210410\\Change string events to anonymous class which implement \\League\\Event\\HasEventName', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    private function shouldSkip(\PhpParser\Node\Expr\MethodCall $methodCall) : bool
    {
        ...
        return !$this->nodeTypeResolver->isObjectTypes($methodCall->var, [new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210410\\League\\Event\\EventDispatcher'), new \PHPStan\Type\ObjectType('Typo3RectorPrefix20210410\\League\\Event\\Emitter')]);
    }
    ...
    {
        $implements = [new \PhpParser\Node\Name\FullyQualified('Typo3RectorPrefix20210410\\League\\Event\\HasEventName')];
